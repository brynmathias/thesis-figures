...
// ------------>Primitives in pad: u
   ...
   JetMultiplicity_all->SetBinContent(3,710036.9);
   JetMultiplicity_all->SetBinContent(4,836682.7);
   JetMultiplicity_all->SetBinContent(5,402312.1);
   JetMultiplicity_all->SetBinContent(6,80575.82);
   JetMultiplicity_all->SetBinContent(7,12484.19);
   JetMultiplicity_all->SetBinContent(8,1490.622);
   JetMultiplicity_all->SetBinContent(9,161.1548);
   JetMultiplicity_all->SetBinContent(10,88.40024);
   JetMultiplicity_all->SetBinContent(11,1.25553);
   JetMultiplicity_all->SetBinContent(12,0.1393525);
   JetMultiplicity_all->SetBinError(3,6276.407);
   JetMultiplicity_all->SetBinError(4,7259.333);
   JetMultiplicity_all->SetBinError(5,5237.165);
   JetMultiplicity_all->SetBinError(6,2003.129);
   JetMultiplicity_all->SetBinError(7,817.9741);
   JetMultiplicity_all->SetBinError(8,141.4813);
   JetMultiplicity_all->SetBinError(9,17.99063);
   JetMultiplicity_all->SetBinError(10,70.84723);
   JetMultiplicity_all->SetBinError(11,0.5511594);
   JetMultiplicity_all->SetBinError(12,0.1393525);
   JetMultiplicity_all->SetEntries(556753);
   ...
   gre->SetPoint(2,2.5,709047.7);
   gre->SetPointError(2,0.5,6276.398);
   gre->SetPoint(3,3.5,833051.9);
   gre->SetPointError(3,0.5,7259.285);
   gre->SetPoint(4,4.5,396536.6);
   gre->SetPointError(4,0.5,5237.024);
   gre->SetPoint(5,5.5,77275.52);
   gre->SetPointError(5,0.5,2002.882);
   gre->SetPoint(6,6.5,11330.07);
   gre->SetPointError(6,0.5,817.7419);
   gre->SetPoint(7,7.5,1193.603);
   gre->SetPointError(7,0.5,141.0508);
   gre->SetPoint(8,8.5,109.0714);
   gre->SetPointError(8,0.5,17.57313);
   gre->SetPoint(9,9.5,78.01017);
   gre->SetPointError(9,0.5,70.82718);
   ...
   Graph_Graph_from_JetMultiplicity_all821->SetMinimum(924.3423);
   Graph_Graph_from_JetMultiplicity_all821->SetMaximum(924342.3);
   ...
   gre->SetPoint(1,1.5,0);
   gre->SetPointError(1,0.5,0);
   gre->SetPoint(2,2.5,710036.9);
   gre->SetPointError(2,0.5,6276.407);
   gre->SetPoint(3,3.5,836682.7);
   gre->SetPointError(3,0.5,7259.333);
   gre->SetPoint(4,4.5,402312.1);
   gre->SetPointError(4,0.5,5237.165);
   gre->SetPoint(5,5.5,80575.82);
   gre->SetPointError(5,0.5,2003.129);
   gre->SetPoint(6,6.5,12484.19);
   gre->SetPointError(6,0.5,817.9741);
   gre->SetPoint(7,7.5,1490.622);
   gre->SetPointError(7,0.5,141.4813);
   gre->SetPoint(8,8.5,161.1548);
   gre->SetPointError(8,0.5,17.99063);
   gre->SetPoint(9,9.5,88.40024);
   gre->SetPointError(9,0.5,70.84723);
   gre->SetPoint(10,10.5,1.25553);
   gre->SetPointError(10,0.5,0.5511594);
   ...
   Graph_Graph_from_JetMultiplicity_all822->SetMinimum(928.3362);
   Graph_Graph_from_JetMultiplicity_all822->SetMaximum(928336.2);
...
// ------------>Primitives in pad: d
   ...
   Graph_Graph_from_JetMultiplicity_all823->SetMinimum(0);
