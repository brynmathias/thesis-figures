...
// ------------>Primitives in pad: u
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis2094[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2094);
   ...
   HT_all->Draw("");
   Double_t xAxis2095[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2095);
   ...
   TH1F *_stack_140 = new TH1F("_stack_140","",100,0,2500);
   _stack_140->SetMinimum(152.2128);
   _stack_140->SetMaximum(608851.2);
   ...
   Double_t xAxis2096[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2096);
   ...
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2097);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis2098[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2098);
   HT_all->SetBinContent(24,15693);
   HT_all->SetBinContent(25,13323);
   HT_all->SetBinContent(26,11249);
   HT_all->SetBinContent(27,9176);
...
// ------------>Primitives in pad: d
   ...
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2099);
   ...
   TH1F *Graph_Graph_from_HT_all350 = new TH1F("Graph_Graph_from_HT_all350","",100,0,2750);
   Graph_Graph_from_HT_all350->SetMinimum(0.9823348);
   Graph_Graph_from_HT_all350->SetMaximum(1.017665);
   Graph_Graph_from_HT_all350->SetDirectory(0);
   Graph_Graph_from_HT_all350->SetStats(0);
   Graph_Graph_from_HT_all350->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all350->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all350->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all350->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all350->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all350->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all350->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all350->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all350->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all350->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all350);
   ...
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2100);
   HT_all->SetBinContent(24,10.77405);
   HT_all->SetBinContent(25,10.91291);
   HT_all->SetBinContent(26,11.02109);
   HT_all->SetBinContent(27,10.98969);
