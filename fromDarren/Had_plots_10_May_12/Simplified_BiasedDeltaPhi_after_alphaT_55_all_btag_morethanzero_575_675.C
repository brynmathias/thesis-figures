...
// ------------>Primitives in pad: u
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis5664[13] = {0, 0.2617994, 0.5235988, 0.7853982, 1.047198, 1.308997, 1.570796, 1.832596, 2.094395, 2.356194, 2.617994, 2.879793, 3.141593}; 
   
   TH1D *BiasedDeltaPhi_after_alphaT_55_all = new TH1D("BiasedDeltaPhi_after_alphaT_55_all","",12, xAxis5664);
   ...
   Double_t xAxis5665[13] = {0, 0.2617994, 0.5235988, 0.7853982, 1.047198, 1.308997, 1.570796, 1.832596, 2.094395, 2.356194, 2.617994, 2.879793, 3.141593}; 
   
   TH1D *BiasedDeltaPhi_after_alphaT_55_all = new TH1D("BiasedDeltaPhi_after_alphaT_55_all","",12, xAxis5665);
   ...
   TH1F *_stack_378 = new TH1F("_stack_378","",12,0,3.141593);
   _stack_378->SetMinimum(0.005089247);
   _stack_378->SetMaximum(20.35699);
   ...
   Double_t xAxis5666[13] = {0, 0.2617994, 0.5235988, 0.7853982, 1.047198, 1.308997, 1.570796, 1.832596, 2.094395, 2.356194, 2.617994, 2.879793, 3.141593}; 
   
   TH1D *BiasedDeltaPhi_after_alphaT_55_all = new TH1D("BiasedDeltaPhi_after_alphaT_55_all","",12, xAxis5666);
   ...
   Double_t xAxis5667[13] = {0, 0.2617994, 0.5235988, 0.7853982, 1.047198, 1.308997, 1.570796, 1.832596, 2.094395, 2.356194, 2.617994, 2.879793, 3.141593}; 
   
   TH1D *BiasedDeltaPhi_after_alphaT_55_all = new TH1D("BiasedDeltaPhi_after_alphaT_55_all","",12, xAxis5667);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis5668[13] = {0, 0.2617994, 0.5235988, 0.7853982, 1.047198, 1.308997, 1.570796, 1.832596, 2.094395, 2.356194, 2.617994, 2.879793, 3.141593}; 
   
   TH1D *BiasedDeltaPhi_after_alphaT_55_all = new TH1D("BiasedDeltaPhi_after_alphaT_55_all","",12, xAxis5668);
   BiasedDeltaPhi_after_alphaT_55_all->SetBinContent(1,7);
   BiasedDeltaPhi_after_alphaT_55_all->SetBinContent(2,8);
   BiasedDeltaPhi_after_alphaT_55_all->SetBinContent(3,7);
   BiasedDeltaPhi_after_alphaT_55_all->SetBinContent(4,4);
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis5669[13] = {0, 0.2617994, 0.5235988, 0.7853982, 1.047198, 1.308997, 1.570796, 1.832596, 2.094395, 2.356194, 2.617994, 2.879793, 3.141593}; 
   
   TH1D *BiasedDeltaPhi_after_alphaT_55_all = new TH1D("BiasedDeltaPhi_after_alphaT_55_all","",12, xAxis5669);
   ...
   TH1F *Graph_Graph_from_BiasedDeltaPhi_after_alphaT_55_all945 = new TH1F("Graph_Graph_from_BiasedDeltaPhi_after_alphaT_55_all945","",100,0,3.455752);
   Graph_Graph_from_BiasedDeltaPhi_after_alphaT_55_all945->SetMinimum(0.3040862);
   Graph_Graph_from_BiasedDeltaPhi_after_alphaT_55_all945->SetMaximum(1.695914);
   Graph_Graph_from_BiasedDeltaPhi_after_alphaT_55_all945->SetDirectory(0);
   Graph_Graph_from_BiasedDeltaPhi_after_alphaT_55_all945->SetStats(0);
   Graph_Graph_from_BiasedDeltaPhi_after_alphaT_55_all945->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_BiasedDeltaPhi_after_alphaT_55_all945->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_BiasedDeltaPhi_after_alphaT_55_all945->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_BiasedDeltaPhi_after_alphaT_55_all945->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_BiasedDeltaPhi_after_alphaT_55_all945->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_BiasedDeltaPhi_after_alphaT_55_all945->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_BiasedDeltaPhi_after_alphaT_55_all945->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_BiasedDeltaPhi_after_alphaT_55_all945->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_BiasedDeltaPhi_after_alphaT_55_all945->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_BiasedDeltaPhi_after_alphaT_55_all945->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_BiasedDeltaPhi_after_alphaT_55_all945);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,3.141593,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis5670[13] = {0, 0.2617994, 0.5235988, 0.7853982, 1.047198, 1.308997, 1.570796, 1.832596, 2.094395, 2.356194, 2.617994, 2.879793, 3.141593}; 
   
   TH1D *BiasedDeltaPhi_after_alphaT_55_all = new TH1D("BiasedDeltaPhi_after_alphaT_55_all","",12, xAxis5670);
   BiasedDeltaPhi_after_alphaT_55_all->SetBinContent(1,0.6284254);
   BiasedDeltaPhi_after_alphaT_55_all->SetBinContent(2,1.061191);
   BiasedDeltaPhi_after_alphaT_55_all->SetBinContent(3,1.295081);
   BiasedDeltaPhi_after_alphaT_55_all->SetBinContent(4,1.012779);
