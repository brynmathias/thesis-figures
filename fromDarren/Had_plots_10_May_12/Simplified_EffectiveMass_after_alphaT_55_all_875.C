...
// ------------>Primitives in pad: u
   ...
   Double_t xAxis3205[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis3205);
   ...
   TH1F *_stack_214 = new TH1F("_stack_214","",75,0,3000);
   _stack_214->SetMinimum(0.003786389);
   _stack_214->SetMaximum(15.14556);
   ...
   Double_t xAxis3206[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis3206);
   ...
   EffectiveMass_after_alphaT_55_all->SetBinContent(38,0.8007871);
   EffectiveMass_after_alphaT_55_all->SetBinContent(39,0.7206725);
   EffectiveMass_after_alphaT_55_all->SetBinContent(40,1.065642);
   EffectiveMass_after_alphaT_55_all->SetBinContent(41,7.004105);
   ...
   EffectiveMass_after_alphaT_55_all->SetBinError(38,0.2514894);
   EffectiveMass_after_alphaT_55_all->SetBinError(39,0.2690358);
   EffectiveMass_after_alphaT_55_all->SetBinError(40,0.3505594);
   EffectiveMass_after_alphaT_55_all->SetBinError(41,2.461868);
   ...
   EffectiveMass_after_alphaT_55_all->SetBinError(69,0.06896457);
   EffectiveMass_after_alphaT_55_all->SetBinError(70,0.02124635);
   EffectiveMass_after_alphaT_55_all->SetEntries(243);
   ...
   Double_t xAxis3207[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis3207);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis3208[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis3208);
   EffectiveMass_after_alphaT_55_all->SetBinContent(41,6);
   EffectiveMass_after_alphaT_55_all->SetBinContent(42,1);
   EffectiveMass_after_alphaT_55_all->SetBinContent(46,1);
   EffectiveMass_after_alphaT_55_all->SetBinContent(47,1);
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis3209[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis3209);
   EffectiveMass_after_alphaT_55_all->SetBinContent(41,0.8566405);
   ...
   EffectiveMass_after_alphaT_55_all->SetBinError(41,0.56838);
   ...
   EffectiveMass_after_alphaT_55_all->SetEntries(3.09544);
   EffectiveMass_after_alphaT_55_all->SetLineWidth(2);
   EffectiveMass_after_alphaT_55_all->SetMarkerStyle(20);
   EffectiveMass_after_alphaT_55_all->SetMarkerSize(1.5);
   EffectiveMass_after_alphaT_55_all->GetXaxis()->SetRange(1,41);
   ...
   gre->SetPointError(37,20,0.3140527);
   gre->SetPoint(38,1540,1);
   gre->SetPointError(38,20,0.3733121);
   gre->SetPoint(39,1580,1);
   gre->SetPointError(39,20,0.3289656);
   gre->SetPoint(40,1620,1);
   gre->SetPointError(40,20,0.3514893);
   ...
   TH1F *Graph_Graph_from_EffectiveMass_after_alphaT_55_all535 = new TH1F("Graph_Graph_from_EffectiveMass_after_alphaT_55_all535","",100,0,3300);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all535->SetMinimum(-0.2);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all535->SetMaximum(2.2);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all535->SetDirectory(0);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all535->SetStats(0);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all535->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all535->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all535->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all535->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all535->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all535->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all535->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all535->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all535->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all535->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_EffectiveMass_after_alphaT_55_all535);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,1640,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis3210[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis3210);
   EffectiveMass_after_alphaT_55_all->SetBinContent(41,0.8566405);
   EffectiveMass_after_alphaT_55_all->SetBinContent(42,1.165739);
   EffectiveMass_after_alphaT_55_all->SetBinContent(46,6.180921);
   EffectiveMass_after_alphaT_55_all->SetBinContent(47,2.149231);
