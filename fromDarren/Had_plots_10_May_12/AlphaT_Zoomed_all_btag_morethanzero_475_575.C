...
//=========  (Thu May 10 12:25:28 2012) by ROOT version5.32/00
   TCanvas *canvasbtag_morethanzero_475_575/AlphaT_Zoomed_all = new TCanvas("canvasbtag_morethanzero_475_575/AlphaT_Zoomed_all", "cannameAlphaT_Zoomed_all",0,0,1200,1200);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: u
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis5101[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5101);
   ...
   Double_t xAxis5102[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5102);
   ...
   Double_t xAxis5103[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5103);
   ...
   AlphaT_Zoomed_all->GetYaxis()->SetTitle(" Events/0.0025");
   AlphaT_Zoomed_all->Draw("HISTSAME");
   Double_t xAxis5104[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5104);
   ...
   AlphaT_Zoomed_all->GetYaxis()->SetTitle(" Events/0.0025");
   AlphaT_Zoomed_all->Draw("HISTSAME");
   Double_t xAxis5105[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5105);
   ...
   AlphaT_Zoomed_all->GetYaxis()->SetTitle(" Events/0.0025");
   AlphaT_Zoomed_all->Draw("HISTSAME");
   Double_t xAxis5106[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5106);
   ...
   AlphaT_Zoomed_all->GetYaxis()->SetTitle(" Events/0.0025");
   AlphaT_Zoomed_all->Draw("HISTSAME");
   Double_t xAxis5107[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5107);
   ...
   AlphaT_Zoomed_all->GetYaxis()->SetTitle(" Events/0.0025");
   AlphaT_Zoomed_all->Draw("HISTSAME");
   Double_t xAxis5108[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5108);
   ...
   AlphaT_Zoomed_all->GetYaxis()->SetTitle(" Events/0.0025");
   AlphaT_Zoomed_all->Draw("HISTSAME");
   Double_t xAxis5109[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5109);
   AlphaT_Zoomed_all->SetBinContent(0,69326.39);
   AlphaT_Zoomed_all->SetBinContent(1,47623.57);
   AlphaT_Zoomed_all->SetBinContent(2,66756.93);
   AlphaT_Zoomed_all->SetBinContent(3,88264.1);
   AlphaT_Zoomed_all->SetBinContent(4,115961.4);
   AlphaT_Zoomed_all->SetBinContent(5,9697.629);
   AlphaT_Zoomed_all->SetBinContent(6,232.7905);
   AlphaT_Zoomed_all->SetBinContent(7,85.55332);
   AlphaT_Zoomed_all->SetBinContent(8,42.44609);
   ...
   AlphaT_Zoomed_all->SetBinError(0,1585.01);
   AlphaT_Zoomed_all->SetBinError(1,1334.974);
   AlphaT_Zoomed_all->SetBinError(2,1921.229);
   AlphaT_Zoomed_all->SetBinError(3,1891.299);
   AlphaT_Zoomed_all->SetBinError(4,2302.73);
   AlphaT_Zoomed_all->SetBinError(5,720.1661);
   AlphaT_Zoomed_all->SetBinError(6,16.78111);
   AlphaT_Zoomed_all->SetBinError(7,7.096241);
   AlphaT_Zoomed_all->SetBinError(8,4.467989);
   ...
   AlphaT_Zoomed_all->SetEntries(147400);
   ...
   gre->SetLineStyle(10);
   gre->SetLineWidth(3);
   gre->SetPoint(0,0.45625,47278.78);
   gre->SetPointError(0,0.00625,1334.939);
   gre->SetPoint(1,0.46875,66273.44);
   gre->SetPointError(1,0.00625,1921.203);
   gre->SetPoint(2,0.48125,87544.19);
   gre->SetPointError(2,0.00625,1891.249);
   gre->SetPoint(3,0.49375,114833.7);
   gre->SetPointError(3,0.00625,2302.665);
   gre->SetPoint(4,0.50625,9213.567);
   gre->SetPointError(4,0.00625,720.0736);
   gre->SetPoint(5,0.51875,97.177);
   gre->SetPointError(5,0.00625,15.78947);
   gre->SetPoint(6,0.53125,10.92125);
   gre->SetPointError(6,0.00625,4.966062);
   gre->SetPoint(7,0.54375,5.675376);
   gre->SetPointError(7,0.00625,3.349145);
   ...
   TH1F *Graph_Graph_from_AlphaT_Zoomed_all851 = new TH1F("Graph_Graph_from_AlphaT_Zoomed_all851","",100,0.435,0.615);
   Graph_Graph_from_AlphaT_Zoomed_all851->SetMinimum(128.8499);
   Graph_Graph_from_AlphaT_Zoomed_all851->SetMaximum(128849.9);
   Graph_Graph_from_AlphaT_Zoomed_all851->SetDirectory(0);
   Graph_Graph_from_AlphaT_Zoomed_all851->SetStats(0);
   Graph_Graph_from_AlphaT_Zoomed_all851->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_AlphaT_Zoomed_all851->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_AlphaT_Zoomed_all851->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_AlphaT_Zoomed_all851->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_AlphaT_Zoomed_all851->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_AlphaT_Zoomed_all851->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_AlphaT_Zoomed_all851->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_AlphaT_Zoomed_all851->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_AlphaT_Zoomed_all851->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_AlphaT_Zoomed_all851->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_AlphaT_Zoomed_all851);
   ...
   gre->SetLineColor(4);
   gre->SetLineWidth(3);
   gre->SetPoint(0,0.45625,47623.57);
   gre->SetPointError(0,0.00625,1334.974);
   gre->SetPoint(1,0.46875,66756.93);
   gre->SetPointError(1,0.00625,1921.229);
   gre->SetPoint(2,0.48125,88264.1);
   gre->SetPointError(2,0.00625,1891.299);
   gre->SetPoint(3,0.49375,115961.4);
   gre->SetPointError(3,0.00625,2302.73);
   gre->SetPoint(4,0.50625,9697.629);
   gre->SetPointError(4,0.00625,720.1661);
   gre->SetPoint(5,0.51875,232.7905);
   gre->SetPointError(5,0.00625,16.78111);
   gre->SetPoint(6,0.53125,85.55332);
   gre->SetPointError(6,0.00625,7.096241);
   gre->SetPoint(7,0.54375,42.44609);
   gre->SetPointError(7,0.00625,4.467989);
   gre->SetPoint(8,0.55625,24.1867);
   gre->SetPointError(8,0.00625,2.185446);
   gre->SetPoint(9,0.56875,14.67017);
   gre->SetPointError(9,0.00625,1.76128);
   gre->SetPoint(10,0.58125,12.89201);
   gre->SetPointError(10,0.00625,1.989437);
   gre->SetPoint(11,0.59375,8.24751);
   gre->SetPointError(11,0.00625,1.226932);
   
   TH1F *Graph_Graph_from_AlphaT_Zoomed_all852 = new TH1F("Graph_Graph_from_AlphaT_Zoomed_all852","",100,0.435,0.615);
   Graph_Graph_from_AlphaT_Zoomed_all852->SetMinimum(6.31852);
   Graph_Graph_from_AlphaT_Zoomed_all852->SetMaximum(130089.8);
   Graph_Graph_from_AlphaT_Zoomed_all852->SetDirectory(0);
   Graph_Graph_from_AlphaT_Zoomed_all852->SetStats(0);
   Graph_Graph_from_AlphaT_Zoomed_all852->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_AlphaT_Zoomed_all852->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_AlphaT_Zoomed_all852->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_AlphaT_Zoomed_all852->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_AlphaT_Zoomed_all852->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_AlphaT_Zoomed_all852->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_AlphaT_Zoomed_all852->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_AlphaT_Zoomed_all852->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_AlphaT_Zoomed_all852->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_AlphaT_Zoomed_all852->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_AlphaT_Zoomed_all852);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis5110[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5110);
   AlphaT_Zoomed_all->SetBinContent(0,3907);
   AlphaT_Zoomed_all->SetBinContent(1,1815);
   AlphaT_Zoomed_all->SetBinContent(2,2606);
   AlphaT_Zoomed_all->SetBinContent(3,3918);
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis5111[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5111);
   ...
   TH1F *Graph_Graph_from_AlphaT_Zoomed_all853 = new TH1F("Graph_Graph_from_AlphaT_Zoomed_all853","",100,0.435,0.615);
   Graph_Graph_from_AlphaT_Zoomed_all853->SetMinimum(0.8148214);
   Graph_Graph_from_AlphaT_Zoomed_all853->SetMaximum(1.185179);
   Graph_Graph_from_AlphaT_Zoomed_all853->SetDirectory(0);
   Graph_Graph_from_AlphaT_Zoomed_all853->SetStats(0);
   Graph_Graph_from_AlphaT_Zoomed_all853->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_AlphaT_Zoomed_all853->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_AlphaT_Zoomed_all853->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_AlphaT_Zoomed_all853->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_AlphaT_Zoomed_all853->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_AlphaT_Zoomed_all853->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_AlphaT_Zoomed_all853->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_AlphaT_Zoomed_all853->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_AlphaT_Zoomed_all853->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_AlphaT_Zoomed_all853->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_AlphaT_Zoomed_all853);
   
   gre->Draw("2");
   TLine *line = new TLine(0.45,1,0.6,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis5112[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5112);
   AlphaT_Zoomed_all->SetBinContent(0,0.05635661);
   AlphaT_Zoomed_all->SetBinContent(1,0.03811138);
   AlphaT_Zoomed_all->SetBinContent(2,0.03903715);
   AlphaT_Zoomed_all->SetBinContent(3,0.04438951);
