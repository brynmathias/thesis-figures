...
// ------------>Primitives in pad: u
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis4014[81] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000}; 
   
   TH1D *HT_after_alphaT_55_all = new TH1D("HT_after_alphaT_55_all","",80, xAxis4014);
   ...
   Double_t xAxis4015[81] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000}; 
   
   TH1D *HT_after_alphaT_55_all = new TH1D("HT_after_alphaT_55_all","",80, xAxis4015);
   ...
   TH1F *_stack_268 = new TH1F("_stack_268","",80,0,2000);
   _stack_268->SetMinimum(0.09487445);
   _stack_268->SetMaximum(379.4978);
   ...
   Double_t xAxis4016[81] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000}; 
   
   TH1D *HT_after_alphaT_55_all = new TH1D("HT_after_alphaT_55_all","",80, xAxis4016);
   HT_after_alphaT_55_all->SetBinContent(14,177.3751);
   HT_after_alphaT_55_all->SetBinContent(15,169.117);
   HT_after_alphaT_55_all->SetBinError(14,12.86849);
   HT_after_alphaT_55_all->SetBinError(15,19.53583);
   HT_after_alphaT_55_all->SetEntries(2776);
   ...
   Double_t xAxis4017[81] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000}; 
   
   TH1D *HT_after_alphaT_55_all = new TH1D("HT_after_alphaT_55_all","",80, xAxis4017);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis4018[81] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000}; 
   
   TH1D *HT_after_alphaT_55_all = new TH1D("HT_after_alphaT_55_all","",80, xAxis4018);
   HT_after_alphaT_55_all->SetBinContent(14,201);
   HT_after_alphaT_55_all->SetBinContent(15,169);
   HT_after_alphaT_55_all->SetBinError(14,14.17745);
   HT_after_alphaT_55_all->SetBinError(15,13);
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis4019[81] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000}; 
   
   TH1D *HT_after_alphaT_55_all = new TH1D("HT_after_alphaT_55_all","",80, xAxis4019);
   HT_after_alphaT_55_all->SetBinContent(14,1.133192);
   HT_after_alphaT_55_all->SetBinContent(15,0.9993079);
   HT_after_alphaT_55_all->SetBinError(14,0.1011858);
   HT_after_alphaT_55_all->SetBinError(15,0.1387849);
   HT_after_alphaT_55_all->SetMinimum(0);
   HT_after_alphaT_55_all->SetMaximum(2);
   HT_after_alphaT_55_all->SetEntries(140.4339);
   HT_after_alphaT_55_all->SetLineWidth(2);
   HT_after_alphaT_55_all->SetMarkerStyle(20);
   HT_after_alphaT_55_all->SetMarkerSize(1.5);
   HT_after_alphaT_55_all->GetXaxis()->SetRange(1,51);
   ...
   gre->SetPointError(13,12.5,0.07254956);
   ...
   TH1F *Graph_Graph_from_HT_after_alphaT_55_all670 = new TH1F("Graph_Graph_from_HT_after_alphaT_55_all670","",100,0,2200);
   Graph_Graph_from_HT_after_alphaT_55_all670->SetMinimum(0.86138);
   Graph_Graph_from_HT_after_alphaT_55_all670->SetMaximum(1.13862);
   Graph_Graph_from_HT_after_alphaT_55_all670->SetDirectory(0);
   Graph_Graph_from_HT_after_alphaT_55_all670->SetStats(0);
   Graph_Graph_from_HT_after_alphaT_55_all670->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_after_alphaT_55_all670->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_after_alphaT_55_all670->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_after_alphaT_55_all670->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_after_alphaT_55_all670->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_after_alphaT_55_all670->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_after_alphaT_55_all670->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_after_alphaT_55_all670->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_after_alphaT_55_all670->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_after_alphaT_55_all670->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_after_alphaT_55_all670);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,1275,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis4020[81] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000}; 
   
   TH1D *HT_after_alphaT_55_all = new TH1D("HT_after_alphaT_55_all","",80, xAxis4020);
   HT_after_alphaT_55_all->SetBinContent(14,1.133192);
   HT_after_alphaT_55_all->SetBinContent(15,0.9993079);
   HT_after_alphaT_55_all->SetBinError(14,0.1011858);
   HT_after_alphaT_55_all->SetBinError(15,0.1387849);
