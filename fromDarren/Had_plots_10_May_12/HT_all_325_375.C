{
//=========Macro generated from canvas: canvas325_375/HT_all/cannameHT_all
//=========  (Thu May 10 12:22:41 2012) by ROOT version5.32/00
   TCanvas *canvas325_375/HT_all = new TCanvas("canvas325_375/HT_all", "cannameHT_all",0,0,1200,1200);
   gStyle->SetOptStat(0);
   canvas325_375/HT_all->SetHighLightColor(2);
   canvas325_375/HT_all->Range(0,0,1,1);
   canvas325_375/HT_all->SetFillColor(0);
   canvas325_375/HT_all->SetBorderMode(0);
   canvas325_375/HT_all->SetBorderSize(2);
   canvas325_375/HT_all->SetTickx(1);
   canvas325_375/HT_all->SetTicky(1);
   canvas325_375/HT_all->SetFrameBorderMode(0);
  
// ------------>Primitives in pad: u
   TPad *u = new TPad("u", "u",0.01,0.25,0.99,0.99);
   u->Draw();
   u->cd();
   u->Range(-159.375,-1.341651,1434.375,9.064555);
   u->SetFillColor(0);
   u->SetBorderMode(0);
   u->SetBorderSize(2);
   u->SetLogy();
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis511[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis511);
   HT_all->SetBinContent(14,11209);
   HT_all->SetBinContent(15,9930);
   HT_all->SetBinError(14,105.8726);
   HT_all->SetBinError(15,99.64939);
   HT_all->SetMinimum(0.5);
   HT_all->SetMaximum(1.056657e+08);
   HT_all->SetEntries(21140);
   ...
   HT_all->Draw("PE0");
   Double_t xAxis512[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis512);
   HT_all->SetBinContent(14,6261.966);
   HT_all->SetBinContent(15,4670.775);
   HT_all->SetBinError(14,166.1164);
   HT_all->SetBinError(15,143.5131);
   HT_all->SetEntries(3454);
   ...
   Double_t xAxis513[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis513);
   HT_all->SetBinContent(14,2625.054);
   HT_all->SetBinContent(15,2580.816);
   HT_all->SetBinError(14,27.34204);
   HT_all->SetBinError(15,27.74375);
   HT_all->SetEntries(25610);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis514[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis514);
   HT_all->SetBinContent(14,2396.088);
   HT_all->SetBinContent(15,1933.605);
   HT_all->SetBinError(14,13.86284);
   HT_all->SetBinError(15,12.53123);
   HT_all->SetEntries(77751);
   ...
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis515);
   HT_all->SetBinContent(14,444.783);
   HT_all->SetBinContent(15,347.3323);
   HT_all->SetBinError(14,17.50987);
   HT_all->SetBinError(15,14.56252);
   HT_all->SetEntries(1819);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis516[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis516);
   HT_all->SetBinContent(14,167.3357);
   HT_all->SetBinContent(15,134.2917);
   HT_all->SetBinError(14,2.111154);
   HT_all->SetBinError(15,1.898833);
   HT_all->SetEntries(21089);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis517[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis517);
   HT_all->SetBinContent(14,1.055407e+07);
   HT_all->SetBinContent(15,7329668);
   HT_all->SetBinError(14,33753.63);
   HT_all->SetBinError(15,26939.19);
   HT_all->SetEntries(357302);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis518[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis518);
   HT_all->SetBinContent(14,607.2703);
   HT_all->SetBinContent(15,516.0567);
   HT_all->SetBinError(14,6.487073);
   HT_all->SetBinError(15,5.942952);
   HT_all->SetEntries(23941);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis519[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis519);
   HT_all->SetBinContent(14,1.056657e+07);
   HT_all->SetBinContent(15,7339850);
   HT_all->SetBinError(14,33754.06);
   HT_all->SetBinError(15,26939.6);
   HT_all->SetEntries(510966);
   ...
   gre->SetPoint(13,337.5,1.055407e+07);
   gre->SetPointError(13,12.5,33753.63);
   gre->SetPoint(14,362.5,7329668);
   gre->SetPointError(14,12.5,26939.19);
   ...
   TH1F *Graph_Graph_from_HT_all86 = new TH1F("Graph_Graph_from_HT_all86","",100,0,2750);
   Graph_Graph_from_HT_all86->SetMinimum(11646.61);
   Graph_Graph_from_HT_all86->SetMaximum(1.164661e+07);
   Graph_Graph_from_HT_all86->SetDirectory(0);
   Graph_Graph_from_HT_all86->SetStats(0);
   Graph_Graph_from_HT_all86->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all86->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all86->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all86->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all86->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all86->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all86->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all86->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all86->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all86->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all86);
   ...
   gre->SetPoint(12,312.5,0);
   gre->SetPointError(12,12.5,0);
   gre->SetPoint(13,337.5,1.056657e+07);
   gre->SetPointError(13,12.5,33754.06);
   gre->SetPoint(14,362.5,7339850);
   gre->SetPointError(14,12.5,26939.6);
   gre->SetPoint(15,387.5,0);
   gre->SetPointError(15,12.5,0);
   gre->SetPoint(16,412.5,0);
   gre->SetPointError(16,12.5,0);
   ...
   TH1F *Graph_Graph_from_HT_all87 = new TH1F("Graph_Graph_from_HT_all87","",100,0,2750);
   Graph_Graph_from_HT_all87->SetMinimum(11660.36);
   Graph_Graph_from_HT_all87->SetMaximum(1.166036e+07);
   Graph_Graph_from_HT_all87->SetDirectory(0);
   Graph_Graph_from_HT_all87->SetStats(0);
   Graph_Graph_from_HT_all87->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all87->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all87->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all87->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all87->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all87->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all87->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all87->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all87->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all87->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all87);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis520[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis520);
   HT_all->SetBinContent(14,11209);
   HT_all->SetBinContent(15,9930);
   HT_all->SetBinError(14,105.8726);
   HT_all->SetBinError(15,99.64939);
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis521[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis521);
   HT_all->SetBinContent(14,0.001060798);
   HT_all->SetBinContent(15,0.001352889);
   HT_all->SetBinError(14,0.009970874);
   HT_all->SetBinError(15,0.01068533);
   HT_all->SetMinimum(0);
   HT_all->SetMaximum(2);
   HT_all->SetEntries(18158.53);
   HT_all->SetLineWidth(2);
   HT_all->SetMarkerStyle(20);
   HT_all->SetMarkerSize(1.5);
   HT_all->GetXaxis()->SetRange(1,51);
   ...
   gre->SetPointError(13,12.5,0.003194419);
   gre->SetPoint(14,362.5,1);
   gre->SetPointError(14,12.5,0.003670319);
   ...
   TH1F *Graph_Graph_from_HT_all88 = new TH1F("Graph_Graph_from_HT_all88","",100,0,2750);
   Graph_Graph_from_HT_all88->SetMinimum(0.9955956);
   Graph_Graph_from_HT_all88->SetMaximum(1.004404);
   Graph_Graph_from_HT_all88->SetDirectory(0);
   Graph_Graph_from_HT_all88->SetStats(0);
   Graph_Graph_from_HT_all88->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all88->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all88->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all88->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all88->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all88->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all88->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all88->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all88->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all88->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all88);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,1270,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis522[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis522);
   HT_all->SetBinContent(14,0.001060798);
   HT_all->SetBinContent(15,0.001352889);
   HT_all->SetBinError(14,0.009970874);
   HT_all->SetBinError(15,0.01068533);
   ...
   d->Modified();
   canvas325_375/HT_all->cd();
   canvas325_375/HT_all->Modified();
   canvas325_375/HT_all->cd();
   canvas325_375/HT_all->SetSelected(canvas325_375/HT_all);
}
