...
// ------------>Primitives in pad: u
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis5844[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Post_AlphaT_5_55_all = new TH1D("Btag_Post_AlphaT_5_55_all","",6, xAxis5844);
   ...
   Double_t xAxis5845[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Post_AlphaT_5_55_all = new TH1D("Btag_Post_AlphaT_5_55_all","",6, xAxis5845);
   ...
   TH1F *_stack_390 = new TH1F("_stack_390","",6,0,6);
   _stack_390->SetMinimum(0.01010994);
   _stack_390->SetMaximum(40.43976);
   ...
   Double_t xAxis5846[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Post_AlphaT_5_55_all = new TH1D("Btag_Post_AlphaT_5_55_all","",6, xAxis5846);
   ...
   Double_t xAxis5847[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Post_AlphaT_5_55_all = new TH1D("Btag_Post_AlphaT_5_55_all","",6, xAxis5847);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis5848[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Post_AlphaT_5_55_all = new TH1D("Btag_Post_AlphaT_5_55_all","",6, xAxis5848);
   Btag_Post_AlphaT_5_55_all->SetBinContent(2,20);
   Btag_Post_AlphaT_5_55_all->SetBinContent(3,11);
   Btag_Post_AlphaT_5_55_all->SetBinError(2,4.472136);
   Btag_Post_AlphaT_5_55_all->SetBinError(3,3.316625);
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis5849[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Post_AlphaT_5_55_all = new TH1D("Btag_Post_AlphaT_5_55_all","",6, xAxis5849);
   ...
   TH1F *Graph_Graph_from_Btag_Post_AlphaT_5_55_all975 = new TH1F("Graph_Graph_from_Btag_Post_AlphaT_5_55_all975","",100,0,6.6);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all975->SetMinimum(0);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all975->SetMaximum(2.2);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all975->SetDirectory(0);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all975->SetStats(0);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all975->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all975->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all975->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all975->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all975->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all975->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all975->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all975->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all975->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all975->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_Btag_Post_AlphaT_5_55_all975);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,6,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis5850[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Post_AlphaT_5_55_all = new TH1D("Btag_Post_AlphaT_5_55_all","",6, xAxis5850);
   Btag_Post_AlphaT_5_55_all->SetBinContent(2,0.8601089);
   Btag_Post_AlphaT_5_55_all->SetBinContent(3,1.099778);
   Btag_Post_AlphaT_5_55_all->SetBinError(2,0.2399195);
   Btag_Post_AlphaT_5_55_all->SetBinError(3,0.3416352);
