...
// ------------>Primitives in pad: u
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis613[13] = {0, 0.2617994, 0.5235988, 0.7853982, 1.047198, 1.308997, 1.570796, 1.832596, 2.094395, 2.356194, 2.617994, 2.879793, 3.141593}; 
   
   TH1D *BiasedDeltaPhi_all = new TH1D("BiasedDeltaPhi_all","",12, xAxis613);
   ...
   TH1F *_stack_41 = new TH1F("_stack_41","",12,0,3.141593);
   _stack_41->SetMinimum(105.9798);
   _stack_41->SetMaximum(423919.1);
   ...
   Double_t xAxis614[13] = {0, 0.2617994, 0.5235988, 0.7853982, 1.047198, 1.308997, 1.570796, 1.832596, 2.094395, 2.356194, 2.617994, 2.879793, 3.141593}; 
   
   TH1D *BiasedDeltaPhi_all = new TH1D("BiasedDeltaPhi_all","",12, xAxis614);
   ...
   Double_t xAxis615[13] = {0, 0.2617994, 0.5235988, 0.7853982, 1.047198, 1.308997, 1.570796, 1.832596, 2.094395, 2.356194, 2.617994, 2.879793, 3.141593}; 
   
   TH1D *BiasedDeltaPhi_all = new TH1D("BiasedDeltaPhi_all","",12, xAxis615);
   ...
   BiasedDeltaPhi_all->GetYaxis()->SetTitle(" Events/0.05 rad");
   ->Add(BiasedDeltaPhi_all,"");
   Double_t xAxis616[13] = {0, 0.2617994, 0.5235988, 0.7853982, 1.047198, 1.308997, 1.570796, 1.832596, 2.094395, 2.356194, 2.617994, 2.879793, 3.141593}; 
   
   TH1D *BiasedDeltaPhi_all = new TH1D("BiasedDeltaPhi_all","",12, xAxis616);
   ...
   BiasedDeltaPhi_all->GetYaxis()->SetTitle(" Events/0.05 rad");
   ->Add(BiasedDeltaPhi_all,"");
   Double_t xAxis617[13] = {0, 0.2617994, 0.5235988, 0.7853982, 1.047198, 1.308997, 1.570796, 1.832596, 2.094395, 2.356194, 2.617994, 2.879793, 3.141593}; 
   
   TH1D *BiasedDeltaPhi_all = new TH1D("BiasedDeltaPhi_all","",12, xAxis617);
   ...
   BiasedDeltaPhi_all->GetYaxis()->SetTitle(" Events/0.05 rad");
   ->Add(BiasedDeltaPhi_all,"");
   Double_t xAxis618[13] = {0, 0.2617994, 0.5235988, 0.7853982, 1.047198, 1.308997, 1.570796, 1.832596, 2.094395, 2.356194, 2.617994, 2.879793, 3.141593}; 
   
   TH1D *BiasedDeltaPhi_all = new TH1D("BiasedDeltaPhi_all","",12, xAxis618);
   ...
   BiasedDeltaPhi_all->GetYaxis()->SetTitle(" Events/0.05 rad");
   ->Add(BiasedDeltaPhi_all,"");
   Double_t xAxis619[13] = {0, 0.2617994, 0.5235988, 0.7853982, 1.047198, 1.308997, 1.570796, 1.832596, 2.094395, 2.356194, 2.617994, 2.879793, 3.141593}; 
   
   TH1D *BiasedDeltaPhi_all = new TH1D("BiasedDeltaPhi_all","",12, xAxis619);
   ...
   BiasedDeltaPhi_all->GetYaxis()->SetTitle(" Events/0.05 rad");
   ->Add(BiasedDeltaPhi_all,"");
   Double_t xAxis620[13] = {0, 0.2617994, 0.5235988, 0.7853982, 1.047198, 1.308997, 1.570796, 1.832596, 2.094395, 2.356194, 2.617994, 2.879793, 3.141593}; 
   
   TH1D *BiasedDeltaPhi_all = new TH1D("BiasedDeltaPhi_all","",12, xAxis620);
   ...
   entry->SetMarkerSize(1);
   leg->Draw();
   Double_t xAxis621[13] = {0, 0.2617994, 0.5235988, 0.7853982, 1.047198, 1.308997, 1.570796, 1.832596, 2.094395, 2.356194, 2.617994, 2.879793, 3.141593}; 
   
   TH1D *BiasedDeltaPhi_all = new TH1D("BiasedDeltaPhi_all","",12, xAxis621);
   BiasedDeltaPhi_all->SetBinContent(1,2100);
   BiasedDeltaPhi_all->SetBinContent(2,709);
   BiasedDeltaPhi_all->SetBinContent(3,244);
   BiasedDeltaPhi_all->SetBinContent(4,75);
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis622[13] = {0, 0.2617994, 0.5235988, 0.7853982, 1.047198, 1.308997, 1.570796, 1.832596, 2.094395, 2.356194, 2.617994, 2.879793, 3.141593}; 
   
   TH1D *BiasedDeltaPhi_all = new TH1D("BiasedDeltaPhi_all","",12, xAxis622);
   ...
   TH1F *Graph_Graph_from_BiasedDeltaPhi_all104 = new TH1F("Graph_Graph_from_BiasedDeltaPhi_all104","",100,0,3.455752);
   Graph_Graph_from_BiasedDeltaPhi_all104->SetMinimum(0.3017496);
   Graph_Graph_from_BiasedDeltaPhi_all104->SetMaximum(1.69825);
   Graph_Graph_from_BiasedDeltaPhi_all104->SetDirectory(0);
   Graph_Graph_from_BiasedDeltaPhi_all104->SetStats(0);
   Graph_Graph_from_BiasedDeltaPhi_all104->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_BiasedDeltaPhi_all104->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_BiasedDeltaPhi_all104->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_BiasedDeltaPhi_all104->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_BiasedDeltaPhi_all104->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_BiasedDeltaPhi_all104->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_BiasedDeltaPhi_all104->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_BiasedDeltaPhi_all104->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_BiasedDeltaPhi_all104->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_BiasedDeltaPhi_all104->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_BiasedDeltaPhi_all104);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,3.141593,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis623[13] = {0, 0.2617994, 0.5235988, 0.7853982, 1.047198, 1.308997, 1.570796, 1.832596, 2.094395, 2.356194, 2.617994, 2.879793, 3.141593}; 
   
   TH1D *BiasedDeltaPhi_all = new TH1D("BiasedDeltaPhi_all","",12, xAxis623);
   BiasedDeltaPhi_all->SetBinContent(1,0.008229829);
   BiasedDeltaPhi_all->SetBinContent(2,0.02732459);
   BiasedDeltaPhi_all->SetBinContent(3,0.05895486);
   BiasedDeltaPhi_all->SetBinContent(4,0.8645928);
