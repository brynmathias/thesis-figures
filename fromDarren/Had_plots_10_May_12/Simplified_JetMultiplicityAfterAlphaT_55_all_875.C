...
//=========  (Thu May 10 12:24:23 2012) by ROOT version5.32/00
   TCanvas *canvas875/JetMultiplicityAfterAlphaT_55_all = new TCanvas("canvas875/JetMultiplicityAfterAlphaT_55_all", "cannameJetMultiplicityAfterAlphaT_55_all",1,1,1200,1176);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: u
   ...
   _stack_228->SetMinimum(0.001658175);
   _stack_228->SetMaximum(6.632702);
   ...
   JetMultiplicityAfterAlphaT_55_all->SetBinContent(5,3.637744);
   JetMultiplicityAfterAlphaT_55_all->SetBinContent(6,2.380951);
   ...
   JetMultiplicityAfterAlphaT_55_all->SetBinError(5,0.5076944);
   JetMultiplicityAfterAlphaT_55_all->SetBinError(6,0.4611625);
...
// ------------>Primitives in pad: d
   ...
   JetMultiplicityAfterAlphaT_55_all->SetBinContent(5,0.2748956);
   JetMultiplicityAfterAlphaT_55_all->SetBinContent(6,1.260001);
   JetMultiplicityAfterAlphaT_55_all->SetBinError(4,1.009425);
   JetMultiplicityAfterAlphaT_55_all->SetBinError(5,1.009692);
   JetMultiplicityAfterAlphaT_55_all->SetBinError(6,0.7391614);
   JetMultiplicityAfterAlphaT_55_all->SetMinimum(0);
   JetMultiplicityAfterAlphaT_55_all->SetMaximum(2);
   JetMultiplicityAfterAlphaT_55_all->SetEntries(3.474816);
   JetMultiplicityAfterAlphaT_55_all->SetLineWidth(2);
   JetMultiplicityAfterAlphaT_55_all->SetMarkerStyle(20);
   JetMultiplicityAfterAlphaT_55_all->SetMarkerSize(1.5);
   ...
   gre->SetPointError(4,0.5,0.139563);
   gre->SetPoint(5,5.5,1);
   gre->SetPointError(5,0.5,0.1936884);
   ...
   Graph_Graph_from_JetMultiplicityAfterAlphaT_55_all570->SetMinimum(0);
   Graph_Graph_from_JetMultiplicityAfterAlphaT_55_all570->SetMaximum(2.2);
