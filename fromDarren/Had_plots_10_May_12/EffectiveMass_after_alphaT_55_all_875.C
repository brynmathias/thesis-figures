...
//=========  (Thu May 10 12:24:15 2012) by ROOT version5.32/00
   TCanvas *canvas875/EffectiveMass_after_alphaT_55_all = new TCanvas("canvas875/EffectiveMass_after_alphaT_55_all", "cannameEffectiveMass_after_alphaT_55_all",0,0,1200,1200);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: u
   ...
   Double_t xAxis3182[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis3182);
   ...
   Double_t xAxis3183[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis3183);
   ...
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis3184);
   ...
   EffectiveMass_after_alphaT_55_all->GetYaxis()->SetTitle(" Events/40 GeV");
   EffectiveMass_after_alphaT_55_all->Draw("HISTSAME");
   Double_t xAxis3185[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis3185);
   ...
   EffectiveMass_after_alphaT_55_all->GetYaxis()->SetTitle(" Events/40 GeV");
   EffectiveMass_after_alphaT_55_all->Draw("HISTSAME");
   Double_t xAxis3186[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis3186);
   ...
   EffectiveMass_after_alphaT_55_all->GetYaxis()->SetTitle(" Events/40 GeV");
   EffectiveMass_after_alphaT_55_all->Draw("HISTSAME");
   Double_t xAxis3187[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis3187);
   ...
   EffectiveMass_after_alphaT_55_all->GetYaxis()->SetTitle(" Events/40 GeV");
   EffectiveMass_after_alphaT_55_all->Draw("HISTSAME");
   Double_t xAxis3188[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis3188);
   ...
   EffectiveMass_after_alphaT_55_all->GetYaxis()->SetTitle(" Events/40 GeV");
   EffectiveMass_after_alphaT_55_all->Draw("HISTSAME");
   Double_t xAxis3189[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis3189);
   EffectiveMass_after_alphaT_55_all->SetBinContent(33,0.5554495);
   EffectiveMass_after_alphaT_55_all->SetBinContent(34,0.3573772);
   EffectiveMass_after_alphaT_55_all->SetBinContent(35,0.7243635);
   EffectiveMass_after_alphaT_55_all->SetBinContent(36,0.8752458);
   EffectiveMass_after_alphaT_55_all->SetBinContent(37,1.303089);
   EffectiveMass_after_alphaT_55_all->SetBinContent(38,0.8879303);
   EffectiveMass_after_alphaT_55_all->SetBinContent(39,0.8211902);
   EffectiveMass_after_alphaT_55_all->SetBinContent(40,1.065642);
   EffectiveMass_after_alphaT_55_all->SetBinContent(41,7.275864);
   EffectiveMass_after_alphaT_55_all->SetBinContent(42,0.8578253);
   EffectiveMass_after_alphaT_55_all->SetBinContent(43,0.394365);
   ...
   EffectiveMass_after_alphaT_55_all->SetBinContent(69,0.06896457);
   EffectiveMass_after_alphaT_55_all->SetBinContent(70,0.02124635);
   EffectiveMass_after_alphaT_55_all->SetBinError(33,0.2067777);
   EffectiveMass_after_alphaT_55_all->SetBinError(34,0.145131);
   EffectiveMass_after_alphaT_55_all->SetBinError(35,0.3514071);
   EffectiveMass_after_alphaT_55_all->SetBinError(36,0.2297988);
   EffectiveMass_after_alphaT_55_all->SetBinError(37,0.2804167);
   EffectiveMass_after_alphaT_55_all->SetBinError(38,0.2661594);
   EffectiveMass_after_alphaT_55_all->SetBinError(39,0.2872003);
   EffectiveMass_after_alphaT_55_all->SetBinError(40,0.3505594);
   EffectiveMass_after_alphaT_55_all->SetBinError(41,2.512836);
   EffectiveMass_after_alphaT_55_all->SetBinError(42,0.2332101);
   EffectiveMass_after_alphaT_55_all->SetBinError(43,0.1465591);
   ...
   EffectiveMass_after_alphaT_55_all->SetBinError(69,0.06896457);
   EffectiveMass_after_alphaT_55_all->SetBinError(70,0.02124635);
   EffectiveMass_after_alphaT_55_all->SetEntries(249);
   ...
   TH1F *Graph_Graph_from_EffectiveMass_after_alphaT_55_all531 = new TH1F("Graph_Graph_from_EffectiveMass_after_alphaT_55_all531","",100,0,3300);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all531->SetMinimum(0.0008528285);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all531->SetMaximum(0.8528285);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all531->SetDirectory(0);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all531->SetStats(0);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all531->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all531->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all531->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all531->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all531->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all531->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all531->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all531->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all531->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all531->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_EffectiveMass_after_alphaT_55_all531);
   ...
   gre->SetPoint(31,1260,0);
   gre->SetPointError(31,20,0);
   gre->SetPoint(32,1300,0.5554495);
   gre->SetPointError(32,20,0.2067777);
   gre->SetPoint(33,1340,0.3573772);
   gre->SetPointError(33,20,0.145131);
   gre->SetPoint(34,1380,0.7243635);
   gre->SetPointError(34,20,0.3514071);
   gre->SetPoint(35,1420,0.8752458);
   gre->SetPointError(35,20,0.2297988);
   gre->SetPoint(36,1460,1.303089);
   gre->SetPointError(36,20,0.2804167);
   gre->SetPoint(37,1500,0.8879303);
   gre->SetPointError(37,20,0.2661594);
   gre->SetPoint(38,1540,0.8211902);
   gre->SetPointError(38,20,0.2872003);
   gre->SetPoint(39,1580,1.065642);
   gre->SetPointError(39,20,0.3505594);
   gre->SetPoint(40,1620,7.275864);
   gre->SetPointError(40,20,2.512836);
   gre->SetPoint(41,1660,0.8578253);
   gre->SetPointError(41,20,0.2332101);
   gre->SetPoint(42,1700,0.394365);
   gre->SetPointError(42,20,0.1465591);
   ...
   TH1F *Graph_Graph_from_EffectiveMass_after_alphaT_55_all532 = new TH1F("Graph_Graph_from_EffectiveMass_after_alphaT_55_all532","",100,0,3300);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all532->SetMinimum(0.01076757);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all532->SetMaximum(10.76757);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all532->SetDirectory(0);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all532->SetStats(0);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all532->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all532->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all532->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all532->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all532->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all532->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all532->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all532->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all532->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all532->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_EffectiveMass_after_alphaT_55_all532);
...
tex->SetNDC();
   ...
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis3190);
   EffectiveMass_after_alphaT_55_all->SetBinContent(41,6);
   EffectiveMass_after_alphaT_55_all->SetBinContent(42,1);
   EffectiveMass_after_alphaT_55_all->SetBinContent(46,1);
   EffectiveMass_after_alphaT_55_all->SetBinContent(47,1);
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis3191[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis3191);
   ...
   TH1F *Graph_Graph_from_EffectiveMass_after_alphaT_55_all533 = new TH1F("Graph_Graph_from_EffectiveMass_after_alphaT_55_all533","",100,0,3300);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all533->SetMinimum(-0.2);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all533->SetMaximum(2.2);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all533->SetDirectory(0);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all533->SetStats(0);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all533->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all533->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all533->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all533->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all533->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all533->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all533->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all533->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all533->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all533->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_EffectiveMass_after_alphaT_55_all533);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,1640,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis3192[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis3192);
   EffectiveMass_after_alphaT_55_all->SetBinContent(41,0.8246443);
   EffectiveMass_after_alphaT_55_all->SetBinContent(42,1.165739);
   EffectiveMass_after_alphaT_55_all->SetBinContent(46,6.180921);
   EffectiveMass_after_alphaT_55_all->SetBinContent(47,2.149231);
