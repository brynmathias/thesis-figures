...
//=========  (Thu May 10 12:07:30 2012) by ROOT version5.32/00
   TCanvas *canvasOneMuon_275_325/HT_all = new TCanvas("canvasOneMuon_275_325/HT_all", "cannameHT_all",0,0,1200,1200);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: u
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis2431[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2431);
   ...
   HT_all->Draw("PE0");
   Double_t xAxis2432[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2432);
   ...
   Double_t xAxis2433[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2433);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis2434[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2434);
   HT_all->SetEntries(1);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis2435[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2435);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis2436[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2436);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis2437[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2437);
   ...
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2438);
   ...
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2439);
   HT_all->SetBinContent(12,5337.529);
   HT_all->SetBinContent(13,4292.172);
   HT_all->SetBinError(12,131.5992);
   HT_all->SetBinError(13,124.0237);
   HT_all->SetEntries(23460);
   ...
   TH1F *Graph_Graph_from_HT_all406 = new TH1F("Graph_Graph_from_HT_all406","",100,0,2750);
   Graph_Graph_from_HT_all406->SetMinimum(0.1094398);
   Graph_Graph_from_HT_all406->SetMaximum(109.4398);
   Graph_Graph_from_HT_all406->SetDirectory(0);
   Graph_Graph_from_HT_all406->SetStats(0);
   Graph_Graph_from_HT_all406->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all406->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all406->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all406->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all406->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all406->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all406->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all406->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all406->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all406->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all406);
   ...
   gre->SetPoint(10,262.5,0);
   gre->SetPointError(10,12.5,0);
   gre->SetPoint(11,287.5,5337.529);
   gre->SetPointError(11,12.5,131.5992);
   gre->SetPoint(12,312.5,4292.172);
   gre->SetPointError(12,12.5,124.0237);
   gre->SetPoint(13,337.5,0);
   gre->SetPointError(13,12.5,0);
   gre->SetPoint(14,362.5,0);
   gre->SetPointError(14,12.5,0);
   ...
   TH1F *Graph_Graph_from_HT_all407 = new TH1F("Graph_Graph_from_HT_all407","",100,0,2750);
   Graph_Graph_from_HT_all407->SetMinimum(6.016041);
   Graph_Graph_from_HT_all407->SetMaximum(6016.041);
   Graph_Graph_from_HT_all407->SetDirectory(0);
   Graph_Graph_from_HT_all407->SetStats(0);
   Graph_Graph_from_HT_all407->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all407->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all407->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all407->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all407->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all407->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all407->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all407->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all407->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all407->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all407);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis2440[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2440);
   HT_all->SetBinContent(12,1031);
   HT_all->SetBinContent(13,1047);
   HT_all->SetBinError(12,32.10919);
   HT_all->SetBinError(13,32.35738);
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis2441[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2441);
   ...
   TH1F *Graph_Graph_from_HT_all408 = new TH1F("Graph_Graph_from_HT_all408","",100,0,2750);
   Graph_Graph_from_HT_all408->SetMinimum(0.9653256);
   Graph_Graph_from_HT_all408->SetMaximum(1.034674);
   Graph_Graph_from_HT_all408->SetDirectory(0);
   Graph_Graph_from_HT_all408->SetStats(0);
   Graph_Graph_from_HT_all408->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all408->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all408->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all408->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all408->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all408->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all408->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all408->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all408->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all408->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all408);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,1270,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis2442[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2442);
   HT_all->SetBinContent(12,0.1931606);
   HT_all->SetBinContent(13,0.2439324);
   HT_all->SetBinError(12,0.03972183);
   HT_all->SetBinError(13,0.04230897);
