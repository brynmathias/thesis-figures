...
//=========  (Thu May 10 12:07:41 2012) by ROOT version5.32/00
   TCanvas *canvasOneMuon_325_375/HT_all = new TCanvas("canvasOneMuon_325_375/HT_all", "cannameHT_all",0,0,1200,1200);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: u
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis2761[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2761);
   ...
   HT_all->Draw("PE0");
   Double_t xAxis2762[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2762);
   HT_all->SetBinContent(14,1975.071);
   HT_all->SetBinContent(15,1521.177);
   HT_all->SetBinError(14,96.55142);
   HT_all->SetBinError(15,76.65144);
   HT_all->SetEntries(1149);
   ...
   Double_t xAxis2763[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2763);
   HT_all->SetBinContent(14,673.336);
   HT_all->SetBinContent(15,602.391);
   HT_all->SetBinError(14,13.44348);
   HT_all->SetBinError(15,12.52409);
   HT_all->SetEntries(6741);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis2764[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2764);
   HT_all->SetEntries(1);
   ...
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2765);
   HT_all->SetBinContent(14,51.90099);
   HT_all->SetBinContent(15,36.07525);
   HT_all->SetBinError(14,5.491434);
   HT_all->SetBinError(15,4.243396);
   HT_all->SetEntries(240);
   ...
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2766);
   HT_all->SetBinContent(14,14.13254);
   HT_all->SetBinContent(15,11.4307);
   HT_all->SetBinError(14,0.6960257);
   HT_all->SetBinError(15,0.6296077);
   HT_all->SetEntries(1025);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis2767[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2767);
   HT_all->SetEntries(1);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis2768[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2768);
   HT_all->SetBinContent(14,72.28693);
   HT_all->SetBinContent(15,58.93331);
   HT_all->SetBinError(14,2.317277);
   HT_all->SetBinError(15,1.871618);
   HT_all->SetEntries(3076);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis2769[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2769);
   ...
   TH1F *Graph_Graph_from_HT_all461 = new TH1F("Graph_Graph_from_HT_all461","",100,0,2750);
   Graph_Graph_from_HT_all461->SetMinimum(0.0011);
   Graph_Graph_from_HT_all461->SetMaximum(1.1);
   Graph_Graph_from_HT_all461->SetDirectory(0);
   Graph_Graph_from_HT_all461->SetStats(0);
   Graph_Graph_from_HT_all461->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all461->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all461->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all461->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all461->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all461->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all461->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all461->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all461->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all461->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all461);
   ...
   gre->SetPoint(12,312.5,0);
   gre->SetPointError(12,12.5,0);
   gre->SetPoint(13,337.5,2786.727);
   gre->SetPointError(13,12.5,97.66736);
   gre->SetPoint(14,362.5,2230.008);
   gre->SetPointError(14,12.5,77.80875);
   gre->SetPoint(15,387.5,0);
   gre->SetPointError(15,12.5,0);
   gre->SetPoint(16,412.5,0);
   gre->SetPointError(16,12.5,0);
   ...
   TH1F *Graph_Graph_from_HT_all462 = new TH1F("Graph_Graph_from_HT_all462","",100,0,2750);
   Graph_Graph_from_HT_all462->SetMinimum(3.172834);
   Graph_Graph_from_HT_all462->SetMaximum(3172.834);
   Graph_Graph_from_HT_all462->SetDirectory(0);
   Graph_Graph_from_HT_all462->SetStats(0);
   Graph_Graph_from_HT_all462->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all462->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all462->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all462->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all462->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all462->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all462->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all462->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all462->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all462->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all462);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis2770[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2770);
   HT_all->SetBinContent(14,697);
   HT_all->SetBinContent(15,572);
   HT_all->SetBinError(14,26.40076);
   HT_all->SetBinError(15,23.91652);
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis2771[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2771);
   ...
   TH1F *Graph_Graph_from_HT_all463 = new TH1F("Graph_Graph_from_HT_all463","",100,0,2750);
   Graph_Graph_from_HT_all463->SetMinimum(0.9579432);
   Graph_Graph_from_HT_all463->SetMaximum(1.042057);
   Graph_Graph_from_HT_all463->SetDirectory(0);
   Graph_Graph_from_HT_all463->SetStats(0);
   Graph_Graph_from_HT_all463->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all463->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all463->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all463->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all463->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all463->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all463->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all463->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all463->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all463->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all463);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,1270,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis2772[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2772);
   HT_all->SetBinContent(14,0.2501142);
   HT_all->SetBinContent(15,0.2565014);
   HT_all->SetBinError(14,0.05160461);
   HT_all->SetBinError(15,0.05445808);
