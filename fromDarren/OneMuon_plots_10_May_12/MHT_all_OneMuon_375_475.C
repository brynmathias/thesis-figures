...
// ------------>Primitives in pad: u
   ...
   MHT_all->SetBinContent(5,455.4372);
   ...
   MHT_all->SetBinError(5,11.62662);
   ...
   Graph_Graph_from_MHT_all61->SetMinimum(0.000297139);
   Graph_Graph_from_MHT_all61->SetMaximum(0.297139);
   ...
   gre->SetLineColor(4);
   gre->SetLineWidth(3);
   gre->SetPoint(0,10,120.003);
   gre->SetPointError(0,10,3.74905);
   gre->SetPoint(1,30,278.2267);
   gre->SetPointError(1,10,5.848997);
   gre->SetPoint(2,50,387.6396);
   gre->SetPointError(2,10,7.410952);
   gre->SetPoint(3,70,429.3482);
   gre->SetPointError(3,10,7.8718);
   gre->SetPoint(4,90,455.4372);
   gre->SetPointError(4,10,11.62662);
   gre->SetPoint(5,110,434.3408);
   gre->SetPointError(5,10,7.757959);
   gre->SetPoint(6,130,420.5083);
   gre->SetPointError(6,10,7.132153);
   gre->SetPoint(7,150,371.3637);
   gre->SetPointError(7,10,6.945349);
   gre->SetPoint(8,170,320.9411);
   gre->SetPointError(8,10,6.398949);
   gre->SetPoint(9,190,263.0832);
   gre->SetPointError(9,10,5.652248);
   gre->SetPoint(10,210,200.3056);
   gre->SetPointError(10,10,4.883047);
   gre->SetPoint(11,230,157.6569);
   gre->SetPointError(11,10,4.375422);
   gre->SetPoint(12,250,125.5892);
   gre->SetPointError(12,10,3.791281);
   gre->SetPoint(13,270,97.05562);
   gre->SetPointError(13,10,3.398487);
   gre->SetPoint(14,290,76.79833);
   gre->SetPointError(14,10,3.904295);
   gre->SetPoint(15,310,58.23333);
   gre->SetPointError(15,10,2.419067);
   gre->SetPoint(16,330,44.27399);
   gre->SetPointError(16,10,2.105484);
   gre->SetPoint(17,350,42.51937);
   gre->SetPointError(17,10,1.948463);
   gre->SetPoint(18,370,43.15871);
   gre->SetPointError(18,10,2.024525);
   gre->SetPoint(19,390,31.64107);
   gre->SetPointError(19,10,1.681298);
   gre->SetPoint(20,410,20.90305);
   gre->SetPointError(20,10,1.422385);
   gre->SetPoint(21,430,12.41327);
   gre->SetPointError(21,10,1.025424);
   gre->SetPoint(22,450,6.622696);
   gre->SetPointError(22,10,0.7150556);
   gre->SetPoint(23,470,1.157806);
   gre->SetPointError(23,10,0.2466666);
   gre->SetPoint(24,490,0);
   gre->SetPointError(24,10,0);
   gre->SetPoint(25,510,0);
   gre->SetPointError(25,10,0);
   ...
   Graph_Graph_from_MHT_all62->SetMinimum(0.5137702);
   Graph_Graph_from_MHT_all62->SetMaximum(513.7702);
...
// ------------>Primitives in pad: d
   ...
   Graph_Graph_from_MHT_all63->SetMinimum(0.744344);
   Graph_Graph_from_MHT_all63->SetMaximum(1.255656);
