...
// ------------>Primitives in pad: u
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis3534[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Pre_AlphaT_5__all = new TH1D("Btag_Pre_AlphaT_5__all","",6, xAxis3534);
   ...
   Double_t xAxis3535[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Pre_AlphaT_5__all = new TH1D("Btag_Pre_AlphaT_5__all","",6, xAxis3535);
   ...
   TH1F *_stack_236 = new TH1F("_stack_236","",6,0,6);
   _stack_236->SetMinimum(0.2379862);
   _stack_236->SetMaximum(951.9449);
   ...
   Double_t xAxis3536[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Pre_AlphaT_5__all = new TH1D("Btag_Pre_AlphaT_5__all","",6, xAxis3536);
   ...
   Double_t xAxis3537[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Pre_AlphaT_5__all = new TH1D("Btag_Pre_AlphaT_5__all","",6, xAxis3537);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis3538[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Pre_AlphaT_5__all = new TH1D("Btag_Pre_AlphaT_5__all","",6, xAxis3538);
   Btag_Pre_AlphaT_5__all->SetBinContent(2,568);
   Btag_Pre_AlphaT_5__all->SetBinContent(3,264);
   Btag_Pre_AlphaT_5__all->SetBinContent(4,22);
   Btag_Pre_AlphaT_5__all->SetBinError(2,23.83275);
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis3539[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Pre_AlphaT_5__all = new TH1D("Btag_Pre_AlphaT_5__all","",6, xAxis3539);
   ...
   TH1F *Graph_Graph_from_Btag_Pre_AlphaT_5__all590 = new TH1F("Graph_Graph_from_Btag_Pre_AlphaT_5__all590","",100,0,6.6);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all590->SetMinimum(0.3040772);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all590->SetMaximum(1.695923);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all590->SetDirectory(0);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all590->SetStats(0);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all590->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all590->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all590->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all590->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all590->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all590->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all590->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all590->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all590->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all590->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_Btag_Pre_AlphaT_5__all590);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,6,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis3540[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Pre_AlphaT_5__all = new TH1D("Btag_Pre_AlphaT_5__all","",6, xAxis3540);
   Btag_Pre_AlphaT_5__all->SetBinContent(2,0.9718075);
   Btag_Pre_AlphaT_5__all->SetBinContent(3,0.9364087);
   Btag_Pre_AlphaT_5__all->SetBinContent(4,0.8434162);
   Btag_Pre_AlphaT_5__all->SetBinError(2,0.04563482);
