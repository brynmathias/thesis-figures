...
// ------------>Primitives in pad: u
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis5244[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Pre_AlphaT_5__all = new TH1D("Btag_Pre_AlphaT_5__all","",6, xAxis5244);
   ...
   Double_t xAxis5245[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Pre_AlphaT_5__all = new TH1D("Btag_Pre_AlphaT_5__all","",6, xAxis5245);
   ...
   TH1F *_stack_350 = new TH1F("_stack_350","",6,0,6);
   _stack_350->SetMinimum(0.01283307);
   _stack_350->SetMaximum(51.33229);
   ...
   Double_t xAxis5246[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Pre_AlphaT_5__all = new TH1D("Btag_Pre_AlphaT_5__all","",6, xAxis5246);
   ...
   Double_t xAxis5247[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Pre_AlphaT_5__all = new TH1D("Btag_Pre_AlphaT_5__all","",6, xAxis5247);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis5248[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Pre_AlphaT_5__all = new TH1D("Btag_Pre_AlphaT_5__all","",6, xAxis5248);
   Btag_Pre_AlphaT_5__all->SetBinContent(2,26);
   Btag_Pre_AlphaT_5__all->SetBinContent(3,14);
   Btag_Pre_AlphaT_5__all->SetBinContent(4,4);
   Btag_Pre_AlphaT_5__all->SetBinError(2,5.09902);
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis5249[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Pre_AlphaT_5__all = new TH1D("Btag_Pre_AlphaT_5__all","",6, xAxis5249);
   ...
   TH1F *Graph_Graph_from_Btag_Pre_AlphaT_5__all875 = new TH1F("Graph_Graph_from_Btag_Pre_AlphaT_5__all875","",100,0,6.6);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all875->SetMinimum(0);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all875->SetMaximum(2.2);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all875->SetDirectory(0);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all875->SetStats(0);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all875->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all875->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all875->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all875->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all875->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all875->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all875->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all875->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all875->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_Btag_Pre_AlphaT_5__all875->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_Btag_Pre_AlphaT_5__all875);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,6,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis5250[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Pre_AlphaT_5__all = new TH1D("Btag_Pre_AlphaT_5__all","",6, xAxis5250);
   Btag_Pre_AlphaT_5__all->SetBinContent(2,0.8714084);
   Btag_Pre_AlphaT_5__all->SetBinContent(3,0.9272943);
   Btag_Pre_AlphaT_5__all->SetBinContent(4,2.300287);
   Btag_Pre_AlphaT_5__all->SetBinError(2,0.2100659);
