...
//=========  (Thu May 10 12:07:32 2012) by ROOT version5.32/00
   TCanvas *canvasOneMuon_275_325/MHT_all = new TCanvas("canvasOneMuon_275_325/MHT_all", "cannameMHT_all",0,0,1200,1200);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: u
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis2491[31] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600}; 
   
   TH1D *MHT_all = new TH1D("MHT_all","",30, xAxis2491);
   ...
   MHT_all->Draw("PE0");
   Double_t xAxis2492[31] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600}; 
   
   TH1D *MHT_all = new TH1D("MHT_all","",30, xAxis2492);
   ...
   Double_t xAxis2493[31] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600}; 
   
   TH1D *MHT_all = new TH1D("MHT_all","",30, xAxis2493);
   ...
   MHT_all->GetYaxis()->SetTitle(" Events/10 GeV");
   MHT_all->Draw("HISTSAME");
   Double_t xAxis2494[31] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600}; 
   
   TH1D *MHT_all = new TH1D("MHT_all","",30, xAxis2494);
   ...
   MHT_all->GetYaxis()->SetTitle(" Events/10 GeV");
   MHT_all->Draw("HISTSAME");
   Double_t xAxis2495[31] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600}; 
   
   TH1D *MHT_all = new TH1D("MHT_all","",30, xAxis2495);
   ...
   MHT_all->GetYaxis()->SetTitle(" Events/10 GeV");
   MHT_all->Draw("HISTSAME");
   Double_t xAxis2496[31] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600}; 
   
   TH1D *MHT_all = new TH1D("MHT_all","",30, xAxis2496);
   ...
   MHT_all->GetYaxis()->SetTitle(" Events/10 GeV");
   MHT_all->Draw("HISTSAME");
   Double_t xAxis2497[31] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600}; 
   
   TH1D *MHT_all = new TH1D("MHT_all","",30, xAxis2497);
   ...
   MHT_all->GetYaxis()->SetTitle(" Events/10 GeV");
   MHT_all->Draw("HISTSAME");
   Double_t xAxis2498[31] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600}; 
   
   TH1D *MHT_all = new TH1D("MHT_all","",30, xAxis2498);
   ...
   MHT_all->GetYaxis()->SetTitle(" Events/10 GeV");
   MHT_all->Draw("HISTSAME");
   Double_t xAxis2499[31] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600}; 
   
   TH1D *MHT_all = new TH1D("MHT_all","",30, xAxis2499);
   MHT_all->SetBinContent(1,329.3161);
   ...
   MHT_all->SetBinError(1,57.63105);
   ...
   TH1F *Graph_Graph_from_MHT_all416 = new TH1F("Graph_Graph_from_MHT_all416","",100,0,660);
   Graph_Graph_from_MHT_all416->SetMinimum(0.1094398);
   Graph_Graph_from_MHT_all416->SetMaximum(109.4398);
   Graph_Graph_from_MHT_all416->SetDirectory(0);
   Graph_Graph_from_MHT_all416->SetStats(0);
   Graph_Graph_from_MHT_all416->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_MHT_all416->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MHT_all416->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MHT_all416->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_MHT_all416->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_MHT_all416->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MHT_all416->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MHT_all416->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_MHT_all416->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MHT_all416->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_MHT_all416);
   ...
   gre->SetLineColor(4);
   gre->SetLineWidth(3);
   gre->SetPoint(0,10,329.3161);
   gre->SetPointError(0,10,57.63105);
   gre->SetPoint(1,30,609.9916);
   gre->SetPointError(1,10,44.95185);
   gre->SetPoint(2,50,943.7114);
   gre->SetPointError(2,10,52.71011);
   gre->SetPoint(3,70,1224.39);
   gre->SetPointError(3,10,62.65636);
   gre->SetPoint(4,90,1292.942);
   gre->SetPointError(4,10,67.89312);
   gre->SetPoint(5,110,1167.419);
   gre->SetPointError(5,10,57.44919);
   gre->SetPoint(6,130,998.8349);
   gre->SetPointError(6,10,53.2799);
   gre->SetPoint(7,150,807.4362);
   gre->SetPointError(7,10,46.83563);
   gre->SetPoint(8,170,658.9734);
   gre->SetPointError(8,10,47.20076);
   gre->SetPoint(9,190,462.916);
   gre->SetPointError(9,10,44.72527);
   gre->SetPoint(10,210,326.7278);
   gre->SetPointError(10,10,34.47829);
   gre->SetPoint(11,230,215.8632);
   gre->SetPointError(11,10,23.77363);
   gre->SetPoint(12,250,224.333);
   gre->SetPointError(12,10,25.44664);
   gre->SetPoint(13,270,176.9432);
   gre->SetPointError(13,10,21.20272);
   gre->SetPoint(14,290,137.9689);
   gre->SetPointError(14,10,21.70154);
   gre->SetPoint(15,310,51.88344);
   gre->SetPointError(15,10,12.71172);
   ...
   TH1F *Graph_Graph_from_MHT_all417 = new TH1F("Graph_Graph_from_MHT_all417","",100,0,660);
   Graph_Graph_from_MHT_all417->SetMinimum(1.496918);
   Graph_Graph_from_MHT_all417->SetMaximum(1496.918);
   Graph_Graph_from_MHT_all417->SetDirectory(0);
   Graph_Graph_from_MHT_all417->SetStats(0);
   Graph_Graph_from_MHT_all417->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_MHT_all417->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MHT_all417->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MHT_all417->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_MHT_all417->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_MHT_all417->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MHT_all417->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MHT_all417->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_MHT_all417->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MHT_all417->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_MHT_all417);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis2500[31] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600}; 
   
   TH1D *MHT_all = new TH1D("MHT_all","",30, xAxis2500);
   MHT_all->SetBinContent(3,1);
   MHT_all->SetBinContent(4,4);
   MHT_all->SetBinContent(5,19);
   MHT_all->SetBinContent(6,124);
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis2501[31] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600}; 
   
   TH1D *MHT_all = new TH1D("MHT_all","",30, xAxis2501);
   ...
   TH1F *Graph_Graph_from_MHT_all418 = new TH1F("Graph_Graph_from_MHT_all418","",100,0,660);
   Graph_Graph_from_MHT_all418->SetMinimum(0);
   Graph_Graph_from_MHT_all418->SetMaximum(2.006161);
   Graph_Graph_from_MHT_all418->SetDirectory(0);
   Graph_Graph_from_MHT_all418->SetStats(0);
   Graph_Graph_from_MHT_all418->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_MHT_all418->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MHT_all418->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MHT_all418->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_MHT_all418->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_MHT_all418->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MHT_all418->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MHT_all418->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_MHT_all418->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MHT_all418->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_MHT_all418);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,520,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis2502[31] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600}; 
   
   TH1D *MHT_all = new TH1D("MHT_all","",30, xAxis2502);
   MHT_all->SetBinContent(3,0.001059646);
   MHT_all->SetBinContent(4,0.003266932);
   MHT_all->SetBinContent(5,0.01469517);
   MHT_all->SetBinContent(6,0.1062172);
