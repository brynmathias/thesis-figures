{
//=========Macro generated from canvas: canvasDiMuon_775_875/MT__all/cannameMT__all
//=========  (Thu May 10 12:45:59 2012) by ROOT version5.32/00
   TCanvas *canvasDiMuon_775_875/MT__all = new TCanvas("canvasDiMuon_775_875/MT__all", "cannameMT__all",0,0,1200,1200);
   gStyle->SetOptStat(0);
   canvasDiMuon_775_875/MT__all->SetHighLightColor(2);
   canvasDiMuon_775_875/MT__all->Range(0,0,1,1);
   canvasDiMuon_775_875/MT__all->SetFillColor(0);
   canvasDiMuon_775_875/MT__all->SetBorderMode(0);
   canvasDiMuon_775_875/MT__all->SetBorderSize(2);
   canvasDiMuon_775_875/MT__all->SetTickx(1);
   canvasDiMuon_775_875/MT__all->SetTicky(1);
   canvasDiMuon_775_875/MT__all->SetFrameBorderMode(0);
  
// ------------>Primitives in pad: u
   TPad *u = new TPad("u", "u",0.01,0.25,0.99,0.99);
   u->Draw();
   u->cd();
   u->Range(-102.5,-0.5587513,922.5,2.018462);
   u->SetFillColor(0);
   u->SetBorderMode(0);
   u->SetBorderSize(2);
   u->SetLogy();
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis2071[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis2071);
   MT__all->SetBinContent(7,1);
   MT__all->SetBinError(7,1);
   MT__all->SetMinimum(0.5);
   MT__all->SetMaximum(57.6422);
   ...
   MT__all->Draw("PE0");
   Double_t xAxis2072[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis2072);
   ...
   Double_t xAxis2073[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis2073);
   MT__all->SetBinContent(1,0.2353455);
   MT__all->SetBinContent(4,0.01514226);
   MT__all->SetBinContent(9,0.1493596);
   MT__all->SetBinContent(18,0.2717112);
   MT__all->SetBinError(1,0.2353455);
   ...
   MT__all->GetXaxis()->SetRange(1,41);
   MT__all->Draw("HISTSAME");
   Double_t xAxis2074[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis2074);
   MT__all->SetEntries(1);
   ...
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis2075);
   MT__all->SetBinContent(1,1.5679);
   MT__all->SetBinContent(2,1.773845);
   MT__all->SetBinContent(3,0.1910565);
   MT__all->SetBinContent(4,1.523236);
   MT__all->SetBinContent(5,1.752391);
   MT__all->SetBinContent(6,5.76422);
   MT__all->SetBinContent(7,1.733395);
   MT__all->SetBinContent(11,0.8201456);
   MT__all->SetBinError(1,0.806455);
   MT__all->SetBinError(2,0.8779917);
   MT__all->SetBinError(3,0.1636514);
   MT__all->SetBinError(4,0.8254169);
   MT__all->SetBinError(5,1.01693);
   MT__all->SetBinError(6,3.145491);
   MT__all->SetBinError(7,1.003101);
   MT__all->SetBinError(11,0.6011703);
   ...
   MT__all->GetXaxis()->SetRange(1,41);
   MT__all->Draw("HISTSAME");
   Double_t xAxis2076[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis2076);
   ...
   MT__all->GetXaxis()->SetRange(1,41);
   MT__all->Draw("HISTSAME");
   Double_t xAxis2077[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis2077);
   MT__all->SetBinContent(1,0.02800957);
   MT__all->SetBinContent(4,0.01475035);
   MT__all->SetBinContent(8,0.01774579);
   MT__all->SetBinError(1,0.0198338);
   MT__all->SetBinError(4,0.01475035);
   MT__all->SetBinError(8,0.01774579);
   MT__all->SetEntries(5);
   ...
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis2078);
   MT__all->SetEntries(1);
   ...
   MT__all->GetXaxis()->SetRange(1,41);
   MT__all->Draw("HISTSAME");
   Double_t xAxis2079[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis2079);
   MT__all->SetBinContent(1,1.831255);
   MT__all->SetBinContent(2,1.773845);
   MT__all->SetBinContent(3,0.1910565);
   MT__all->SetBinContent(4,1.587861);
   MT__all->SetBinContent(5,1.752391);
   MT__all->SetBinContent(6,5.76422);
   MT__all->SetBinContent(7,1.733395);
   MT__all->SetBinContent(8,0.01774579);
   ...
   MT__all->SetBinContent(11,0.8201456);
   MT__all->SetBinContent(18,0.2717112);
   MT__all->SetBinError(1,0.8403276);
   MT__all->SetBinError(2,0.8779917);
   MT__all->SetBinError(3,0.1636514);
   MT__all->SetBinError(4,0.8260527);
   MT__all->SetBinError(5,1.01693);
   MT__all->SetBinError(6,3.145491);
   MT__all->SetBinError(7,1.003101);
   MT__all->SetBinError(8,0.01774579);
   ...
   TH1F *Graph_Graph_from_MT__all346 = new TH1F("Graph_Graph_from_MT__all346","",100,0,2200);
   Graph_Graph_from_MT__all346->SetMinimum(0.0011);
   Graph_Graph_from_MT__all346->SetMaximum(1.1);
   Graph_Graph_from_MT__all346->SetDirectory(0);
   Graph_Graph_from_MT__all346->SetStats(0);
   Graph_Graph_from_MT__all346->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all346->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all346->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MT__all346->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_MT__all346->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all346->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all346->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MT__all346->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all346->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all346->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_MT__all346);
   ...
   gre->SetLineColor(4);
   gre->SetLineWidth(3);
   gre->SetPoint(0,10,1.831255);
   gre->SetPointError(0,10,0.8403276);
   gre->SetPoint(1,30,1.773845);
   gre->SetPointError(1,10,0.8779917);
   gre->SetPoint(2,50,0.1910565);
   gre->SetPointError(2,10,0.1636514);
   gre->SetPoint(3,70,1.587861);
   gre->SetPointError(3,10,0.8260527);
   gre->SetPoint(4,90,1.752391);
   gre->SetPointError(4,10,1.01693);
   gre->SetPoint(5,110,5.76422);
   gre->SetPointError(5,10,3.145491);
   gre->SetPoint(6,130,1.733395);
   gre->SetPointError(6,10,1.003101);
   gre->SetPoint(7,150,0.01774579);
   gre->SetPointError(7,10,0.01774579);
   gre->SetPoint(8,170,0.1493596);
   gre->SetPointError(8,10,0.1493596);
   gre->SetPoint(9,190,0);
   gre->SetPointError(9,10,0);
   gre->SetPoint(10,210,0.8201456);
   gre->SetPointError(10,10,0.6011703);
   gre->SetPoint(11,230,0);
   gre->SetPointError(11,10,0);
   gre->SetPoint(12,250,0);
   gre->SetPointError(12,10,0);
   ...
   gre->SetPoint(16,330,0);
   gre->SetPointError(16,10,0);
   gre->SetPoint(17,350,0.2717112);
   gre->SetPointError(17,10,0.2717112);
   gre->SetPoint(18,370,0);
   gre->SetPointError(18,10,0);
   gre->SetPoint(19,390,0);
   gre->SetPointError(19,10,0);
   ...
   TH1F *Graph_Graph_from_MT__all347 = new TH1F("Graph_Graph_from_MT__all347","",100,0,2200);
   Graph_Graph_from_MT__all347->SetMinimum(0.009800682);
   Graph_Graph_from_MT__all347->SetMaximum(9.800682);
   Graph_Graph_from_MT__all347->SetDirectory(0);
   Graph_Graph_from_MT__all347->SetStats(0);
   Graph_Graph_from_MT__all347->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all347->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all347->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MT__all347->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_MT__all347->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all347->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all347->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MT__all347->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all347->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all347->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_MT__all347);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis2080[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis2080);
   MT__all->SetBinContent(7,1);
   MT__all->SetBinError(7,1);
   MT__all->SetMinimum(0.5);
   MT__all->SetMaximum(57.6422);
   ...
   MT__all->Draw("PSAME");
   u->Modified();
   canvasDiMuon_775_875/MT__all->cd();
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis2081[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis2081);
   MT__all->SetBinContent(7,0.5769026);
   MT__all->SetBinError(7,1.155372);
   MT__all->SetMinimum(0);
   MT__all->SetMaximum(2);
   MT__all->SetEntries(0.7491289);
   MT__all->SetLineWidth(2);
   MT__all->SetMarkerStyle(20);
   MT__all->SetMarkerSize(1.5);
   MT__all->GetXaxis()->SetRange(1,41);
   ...
   gre->SetPoint(0,10,1);
   gre->SetPointError(0,10,0.4588807);
   gre->SetPoint(1,30,1);
   gre->SetPointError(1,10,0.4949653);
   gre->SetPoint(2,50,1);
   gre->SetPointError(2,10,0.8565604);
   gre->SetPoint(3,70,1);
   gre->SetPointError(3,10,0.52023);
   gre->SetPoint(4,90,1);
   gre->SetPointError(4,10,0.58031);
   gre->SetPoint(5,110,1);
   gre->SetPointError(5,10,0.5456925);
   gre->SetPoint(6,130,1);
   gre->SetPointError(6,10,0.5786915);
   ...
   gre->SetPointError(10,10,0.7330043);
   ...
   TH1F *Graph_Graph_from_MT__all348 = new TH1F("Graph_Graph_from_MT__all348","",100,0,2200);
   Graph_Graph_from_MT__all348->SetMinimum(-0.2);
   Graph_Graph_from_MT__all348->SetMaximum(2.2);
   Graph_Graph_from_MT__all348->SetDirectory(0);
   Graph_Graph_from_MT__all348->SetStats(0);
   Graph_Graph_from_MT__all348->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all348->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all348->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MT__all348->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_MT__all348->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all348->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all348->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MT__all348->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all348->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all348->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_MT__all348);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,820,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis2082[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis2082);
   MT__all->SetBinContent(7,0.5769026);
   MT__all->SetBinError(7,1.155372);
   MT__all->SetMinimum(0);
   MT__all->SetMaximum(2);
   ...
   d->Modified();
   canvasDiMuon_775_875/MT__all->cd();
   canvasDiMuon_775_875/MT__all->Modified();
   canvasDiMuon_775_875/MT__all->cd();
   canvasDiMuon_775_875/MT__all->SetSelected(canvasDiMuon_775_875/MT__all);
}
