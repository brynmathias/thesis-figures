{
//=========Macro generated from canvas: canvasDiMuon_275_325/HT_all/cannameHT_all
//=========  (Thu May 10 12:46:17 2012) by ROOT version5.32/00
   TCanvas *canvasDiMuon_275_325/HT_all = new TCanvas("canvasDiMuon_275_325/HT_all", "cannameHT_all",0,0,1200,1200);
   gStyle->SetOptStat(0);
   canvasDiMuon_275_325/HT_all->SetHighLightColor(2);
   canvasDiMuon_275_325/HT_all->Range(0,0,1,1);
   canvasDiMuon_275_325/HT_all->SetFillColor(0);
   canvasDiMuon_275_325/HT_all->SetBorderMode(0);
   canvasDiMuon_275_325/HT_all->SetBorderSize(2);
   canvasDiMuon_275_325/HT_all->SetTickx(1);
   canvasDiMuon_275_325/HT_all->SetTicky(1);
   canvasDiMuon_275_325/HT_all->SetFrameBorderMode(0);
  
// ------------>Primitives in pad: u
   TPad *u = new TPad("u", "u",0.01,0.25,0.99,0.99);
   u->Draw();
   u->cd();
   u->Range(-159.375,-0.7867882,1434.375,4.070794);
   u->SetFillColor(0);
   u->SetBorderMode(0);
   u->SetBorderSize(2);
   u->SetLogy();
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis2641[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2641);
   HT_all->SetBinContent(12,75);
   HT_all->SetBinContent(13,76);
   HT_all->SetBinError(12,8.660254);
   HT_all->SetBinError(13,8.717798);
   HT_all->SetMinimum(0.5);
   HT_all->SetMaximum(3846.234);
   HT_all->SetEntries(152);
   ...
   HT_all->Draw("PE0");
   Double_t xAxis2642[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2642);
   HT_all->SetEntries(1);
   ...
   Double_t xAxis2643[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2643);
   HT_all->SetBinContent(12,21.27695);
   HT_all->SetBinContent(13,16.8522);
   HT_all->SetBinError(12,2.408038);
   HT_all->SetBinError(13,2.14325);
   HT_all->SetEntries(189);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis2644[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2644);
   HT_all->SetEntries(1);
   ...
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2645);
   HT_all->SetBinContent(12,359.2704);
   HT_all->SetBinContent(13,277.5178);
   HT_all->SetBinError(12,14.17534);
   HT_all->SetBinError(13,12.35935);
   HT_all->SetEntries(1568);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis2646[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2646);
   HT_all->SetBinContent(12,0.8614415);
   HT_all->SetBinContent(13,0.3902341);
   HT_all->SetBinError(12,0.2390595);
   HT_all->SetBinError(13,0.1368744);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis2647[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2647);
   HT_all->SetBinContent(12,3.214636);
   HT_all->SetBinContent(13,2.154854);
   HT_all->SetBinError(12,0.1993904);
   HT_all->SetBinError(13,0.153765);
   HT_all->SetEntries(642);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis2648[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2648);
   HT_all->SetEntries(1);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis2649[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2649);
   HT_all->SetBinContent(12,384.6234);
   HT_all->SetBinContent(13,296.9151);
   HT_all->SetBinError(12,14.38178);
   HT_all->SetBinError(13,12.5455);
   HT_all->SetEntries(2435);
   ...
   TH1F *Graph_Graph_from_HT_all441 = new TH1F("Graph_Graph_from_HT_all441","",100,0,2750);
   Graph_Graph_from_HT_all441->SetMinimum(0.0011);
   Graph_Graph_from_HT_all441->SetMaximum(1.1);
   Graph_Graph_from_HT_all441->SetDirectory(0);
   Graph_Graph_from_HT_all441->SetStats(0);
   Graph_Graph_from_HT_all441->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all441->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all441->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all441->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all441->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all441->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all441->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all441->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all441->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all441->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all441);
   ...
   gre->SetPoint(10,262.5,0);
   gre->SetPointError(10,12.5,0);
   gre->SetPoint(11,287.5,384.6234);
   gre->SetPointError(11,12.5,14.38178);
   gre->SetPoint(12,312.5,296.9151);
   gre->SetPointError(12,12.5,12.5455);
   gre->SetPoint(13,337.5,0);
   gre->SetPointError(13,12.5,0);
   gre->SetPoint(14,362.5,0);
   gre->SetPointError(14,12.5,0);
   ...
   TH1F *Graph_Graph_from_HT_all442 = new TH1F("Graph_Graph_from_HT_all442","",100,0,2750);
   Graph_Graph_from_HT_all442->SetMinimum(0.4389057);
   Graph_Graph_from_HT_all442->SetMaximum(438.9057);
   Graph_Graph_from_HT_all442->SetDirectory(0);
   Graph_Graph_from_HT_all442->SetStats(0);
   Graph_Graph_from_HT_all442->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all442->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all442->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all442->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all442->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all442->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all442->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all442->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all442->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all442->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all442);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis2650[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2650);
   HT_all->SetBinContent(12,75);
   HT_all->SetBinContent(13,76);
   HT_all->SetBinError(12,8.660254);
   HT_all->SetBinError(13,8.717798);
   ...
   HT_all->Draw("PSAME");
   u->Modified();
   canvasDiMuon_275_325/HT_all->cd();
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis2651[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2651);
   HT_all->SetBinContent(12,0.1949959);
   HT_all->SetBinContent(13,0.2559654);
   HT_all->SetBinError(12,0.1213733);
   HT_all->SetBinError(13,0.1222424);
   HT_all->SetMinimum(0);
   HT_all->SetMaximum(2);
   HT_all->SetEntries(133.1251);
   HT_all->SetLineWidth(2);
   HT_all->SetMarkerStyle(20);
   HT_all->SetMarkerSize(1.5);
   HT_all->GetXaxis()->SetRange(1,51);
   ...
   gre->SetPointError(11,12.5,0.03739186);
   gre->SetPoint(12,312.5,1);
   gre->SetPointError(12,12.5,0.0422528);
   ...
   TH1F *Graph_Graph_from_HT_all443 = new TH1F("Graph_Graph_from_HT_all443","",100,0,2750);
   Graph_Graph_from_HT_all443->SetMinimum(0.9492966);
   Graph_Graph_from_HT_all443->SetMaximum(1.050703);
   Graph_Graph_from_HT_all443->SetDirectory(0);
   Graph_Graph_from_HT_all443->SetStats(0);
   Graph_Graph_from_HT_all443->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all443->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all443->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all443->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all443->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all443->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all443->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all443->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all443->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all443->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all443);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,1270,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis2652[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis2652);
   HT_all->SetBinContent(12,0.1949959);
   HT_all->SetBinContent(13,0.2559654);
   HT_all->SetBinError(12,0.1213733);
   HT_all->SetBinError(13,0.1222424);
   ...
   d->Modified();
   canvasDiMuon_275_325/HT_all->cd();
   canvasDiMuon_275_325/HT_all->Modified();
   canvasDiMuon_275_325/HT_all->cd();
   canvasDiMuon_275_325/HT_all->SetSelected(canvasDiMuon_275_325/HT_all);
}
