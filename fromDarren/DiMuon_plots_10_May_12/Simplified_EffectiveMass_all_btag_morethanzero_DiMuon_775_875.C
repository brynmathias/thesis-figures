...
// ------------>Primitives in pad: u
   ...
   Double_t xAxis5215[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_all = new TH1D("EffectiveMass_all","",75, xAxis5215);
   ...
   TH1F *_stack_348 = new TH1F("_stack_348","",75,0,3000);
   _stack_348->SetMinimum(0.0004857771);
   _stack_348->SetMaximum(1.943108);
   ...
   TH1D *EffectiveMass_all = new TH1D("EffectiveMass_all","",75, xAxis5216);
   ...
   Double_t xAxis5217[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_all = new TH1D("EffectiveMass_all","",75, xAxis5217);
   EffectiveMass_all->SetEntries(1);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis5218[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_all = new TH1D("EffectiveMass_all","",75, xAxis5218);
   EffectiveMass_all->SetBinContent(23,1);
   EffectiveMass_all->SetBinError(23,1);
   EffectiveMass_all->SetMinimum(0.5);
   EffectiveMass_all->SetMaximum(10);
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis5219[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_all = new TH1D("EffectiveMass_all","",75, xAxis5219);
   ...
   TH1F *Graph_Graph_from_EffectiveMass_all870 = new TH1F("Graph_Graph_from_EffectiveMass_all870","",100,0,3300);
   Graph_Graph_from_EffectiveMass_all870->SetMinimum(0);
   Graph_Graph_from_EffectiveMass_all870->SetMaximum(2.2);
   Graph_Graph_from_EffectiveMass_all870->SetDirectory(0);
   Graph_Graph_from_EffectiveMass_all870->SetStats(0);
   Graph_Graph_from_EffectiveMass_all870->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_all870->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_all870->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_EffectiveMass_all870->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_EffectiveMass_all870->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_all870->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_all870->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_EffectiveMass_all870->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_all870->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_all870->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_EffectiveMass_all870);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,1640,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis5220[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_all = new TH1D("EffectiveMass_all","",75, xAxis5220);
   EffectiveMass_all->SetMinimum(0);
   EffectiveMass_all->SetMaximum(2);
   EffectiveMass_all->SetLineWidth(2);
   EffectiveMass_all->SetMarkerStyle(20);
