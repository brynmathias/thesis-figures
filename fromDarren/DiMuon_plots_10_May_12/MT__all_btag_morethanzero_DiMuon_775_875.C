...
//=========  (Thu May 10 12:47:41 2012) by ROOT version5.32/00
   TCanvas *canvasbtag_morethanzero_DiMuon_775_875/MT__all = new TCanvas("canvasbtag_morethanzero_DiMuon_775_875/MT__all", "cannameMT__all",0,0,1200,1200);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: u
   ...
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis5311);
   ...
   MT__all->Draw("PE0");
   Double_t xAxis5312[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis5312);
   ...
   Double_t xAxis5313[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis5313);
   ...
   MT__all->GetXaxis()->SetRange(1,41);
   MT__all->Draw("HISTSAME");
   Double_t xAxis5314[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis5314);
   MT__all->SetEntries(1);
   ...
   MT__all->GetXaxis()->SetRange(1,41);
   MT__all->Draw("HISTSAME");
   Double_t xAxis5315[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis5315);
   ...
   MT__all->GetXaxis()->SetRange(1,41);
   MT__all->Draw("HISTSAME");
   Double_t xAxis5316[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis5316);
   ...
   MT__all->GetXaxis()->SetRange(1,41);
   MT__all->Draw("HISTSAME");
   Double_t xAxis5317[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis5317);
   ...
   MT__all->GetXaxis()->SetRange(1,41);
   MT__all->Draw("HISTSAME");
   Double_t xAxis5318[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis5318);
   MT__all->SetEntries(1);
   ...
   MT__all->GetXaxis()->SetRange(1,41);
   MT__all->Draw("HISTSAME");
   Double_t xAxis5319[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis5319);
   MT__all->SetBinContent(1,0.3113358);
   MT__all->SetBinContent(3,0.03021939);
   MT__all->SetBinContent(4,0.04987401);
   MT__all->SetBinContent(9,0.1493596);
   MT__all->SetBinContent(11,0.522069);
   MT__all->SetBinContent(18,0.2717112);
   MT__all->SetBinError(1,0.2983714);
   MT__all->SetBinError(3,0.03021939);
   MT__all->SetBinError(4,0.02885196);
   MT__all->SetBinError(9,0.1493596);
   MT__all->SetBinError(11,0.522069);
   MT__all->SetBinError(18,0.2717112);
   ...
   TH1F *Graph_Graph_from_MT__all886 = new TH1F("Graph_Graph_from_MT__all886","",100,0,2200);
   Graph_Graph_from_MT__all886->SetMinimum(0.0011);
   Graph_Graph_from_MT__all886->SetMaximum(1.1);
   Graph_Graph_from_MT__all886->SetDirectory(0);
   Graph_Graph_from_MT__all886->SetStats(0);
   Graph_Graph_from_MT__all886->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all886->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all886->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MT__all886->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_MT__all886->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all886->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all886->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MT__all886->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all886->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all886->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_MT__all886);
   ...
   gre->SetLineColor(4);
   gre->SetLineWidth(3);
   gre->SetPoint(0,10,0.3113358);
   gre->SetPointError(0,10,0.2983714);
   gre->SetPoint(1,30,0);
   gre->SetPointError(1,10,0);
   gre->SetPoint(2,50,0.03021939);
   gre->SetPointError(2,10,0.03021939);
   gre->SetPoint(3,70,0.04987401);
   gre->SetPointError(3,10,0.02885196);
   gre->SetPoint(4,90,0);
   gre->SetPointError(4,10,0);
   gre->SetPoint(5,110,0);
   gre->SetPointError(5,10,0);
   ...
   gre->SetPoint(9,190,0);
   gre->SetPointError(9,10,0);
   gre->SetPoint(10,210,0.522069);
   gre->SetPointError(10,10,0.522069);
   gre->SetPoint(11,230,0);
   gre->SetPointError(11,10,0);
   gre->SetPoint(12,250,0);
   gre->SetPointError(12,10,0);
   ...
   TH1F *Graph_Graph_from_MT__all887 = new TH1F("Graph_Graph_from_MT__all887","",100,0,2200);
   Graph_Graph_from_MT__all887->SetMinimum(0.001148552);
   Graph_Graph_from_MT__all887->SetMaximum(1.148552);
   Graph_Graph_from_MT__all887->SetDirectory(0);
   Graph_Graph_from_MT__all887->SetStats(0);
   Graph_Graph_from_MT__all887->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all887->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all887->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MT__all887->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_MT__all887->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all887->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all887->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MT__all887->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all887->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all887->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_MT__all887);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis5320[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis5320);
   MT__all->SetBinContent(7,1);
   MT__all->SetBinError(7,1);
   MT__all->SetMinimum(0.5);
   MT__all->SetMaximum(10);
...
// ------------>Primitives in pad: d
   ...
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis5321);
   ...
   TH1F *Graph_Graph_from_MT__all888 = new TH1F("Graph_Graph_from_MT__all888","",100,0,2200);
   Graph_Graph_from_MT__all888->SetMinimum(0);
   Graph_Graph_from_MT__all888->SetMaximum(2.2);
   Graph_Graph_from_MT__all888->SetDirectory(0);
   Graph_Graph_from_MT__all888->SetStats(0);
   Graph_Graph_from_MT__all888->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all888->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all888->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MT__all888->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_MT__all888->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all888->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all888->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MT__all888->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all888->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all888->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_MT__all888);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,820,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis5322[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis5322);
   MT__all->SetMinimum(0);
   MT__all->SetMaximum(2);
   MT__all->SetLineWidth(2);
   MT__all->SetMarkerStyle(20);
