{
//=========Macro generated from canvas: canvasbtag_morethanzero_DiMuon_275_325/HT_all/cannameHT_all
//=========  (Thu May 10 12:47:58 2012) by ROOT version5.32/00
   TCanvas *canvasbtag_morethanzero_DiMuon_275_325/HT_all = new TCanvas("canvasbtag_morethanzero_DiMuon_275_325/HT_all", "cannameHT_all",0,0,1200,1200);
   gStyle->SetOptStat(0);
   canvasbtag_morethanzero_DiMuon_275_325/HT_all->SetHighLightColor(2);
   canvasbtag_morethanzero_DiMuon_275_325/HT_all->Range(0,0,1,1);
   canvasbtag_morethanzero_DiMuon_275_325/HT_all->SetFillColor(0);
   canvasbtag_morethanzero_DiMuon_275_325/HT_all->SetBorderMode(0);
   canvasbtag_morethanzero_DiMuon_275_325/HT_all->SetBorderSize(2);
   canvasbtag_morethanzero_DiMuon_275_325/HT_all->SetTickx(1);
   canvasbtag_morethanzero_DiMuon_275_325/HT_all->SetTicky(1);
   canvasbtag_morethanzero_DiMuon_275_325/HT_all->SetFrameBorderMode(0);
  
// ------------>Primitives in pad: u
   TPad *u = new TPad("u", "u",0.01,0.25,0.99,0.99);
   u->Draw();
   u->cd();
   u->Range(-159.375,-0.6875598,1434.375,3.177738);
   u->SetFillColor(0);
   u->SetBorderMode(0);
   u->SetBorderSize(2);
   u->SetLogy();
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis5881[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis5881);
   HT_all->SetBinContent(12,12);
   HT_all->SetBinContent(13,10);
   HT_all->SetBinError(12,3.464102);
   HT_all->SetBinError(13,3.162278);
   HT_all->SetMinimum(0.5);
   HT_all->SetMaximum(618.3133);
   ...
   HT_all->Draw("PE0");
   Double_t xAxis5882[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis5882);
   HT_all->SetEntries(1);
   ...
   Double_t xAxis5883[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis5883);
   HT_all->SetBinContent(12,19.03782);
   HT_all->SetBinContent(13,14.8793);
   HT_all->SetBinError(12,2.297215);
   HT_all->SetBinError(13,2.001644);
   HT_all->SetEntries(169);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis5884[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis5884);
   HT_all->SetEntries(1);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis5885[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis5885);
   HT_all->SetBinContent(12,41.5085);
   HT_all->SetBinContent(13,29.94538);
   HT_all->SetBinError(12,4.632373);
   HT_all->SetBinError(13,3.816184);
   HT_all->SetEntries(181);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis5886[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis5886);
   HT_all->SetBinContent(12,0.7608471);
   HT_all->SetBinContent(13,0.3231576);
   HT_all->SetBinError(12,0.2280561);
   HT_all->SetBinError(13,0.130729);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis5887[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis5887);
   HT_all->SetBinContent(12,0.5241728);
   HT_all->SetBinContent(13,0.4705058);
   HT_all->SetBinError(12,0.06845377);
   HT_all->SetBinError(13,0.07010899);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis5888[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis5888);
   HT_all->SetEntries(1);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis5889[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis5889);
   HT_all->SetBinContent(12,61.83133);
   HT_all->SetBinContent(13,45.61835);
   HT_all->SetBinError(12,5.176174);
   HT_all->SetBinError(13,4.311826);
   HT_all->SetEntries(516);
   ...
   TH1F *Graph_Graph_from_HT_all981 = new TH1F("Graph_Graph_from_HT_all981","",100,0,2750);
   Graph_Graph_from_HT_all981->SetMinimum(0.0011);
   Graph_Graph_from_HT_all981->SetMaximum(1.1);
   Graph_Graph_from_HT_all981->SetDirectory(0);
   Graph_Graph_from_HT_all981->SetStats(0);
   Graph_Graph_from_HT_all981->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all981->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all981->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all981->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all981->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all981->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all981->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all981->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all981->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all981->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all981);
   ...
   gre->SetPoint(10,262.5,0);
   gre->SetPointError(10,12.5,0);
   gre->SetPoint(11,287.5,61.83133);
   gre->SetPointError(11,12.5,5.176174);
   gre->SetPoint(12,312.5,45.61835);
   gre->SetPointError(12,12.5,4.311826);
   gre->SetPoint(13,337.5,0);
   gre->SetPointError(13,12.5,0);
   gre->SetPoint(14,362.5,0);
   gre->SetPointError(14,12.5,0);
   ...
   TH1F *Graph_Graph_from_HT_all982 = new TH1F("Graph_Graph_from_HT_all982","",100,0,2750);
   Graph_Graph_from_HT_all982->SetMinimum(0.07370826);
   Graph_Graph_from_HT_all982->SetMaximum(73.70826);
   Graph_Graph_from_HT_all982->SetDirectory(0);
   Graph_Graph_from_HT_all982->SetStats(0);
   Graph_Graph_from_HT_all982->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all982->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all982->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all982->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all982->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all982->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all982->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all982->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all982->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all982->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all982);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis5890[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis5890);
   HT_all->SetBinContent(12,12);
   HT_all->SetBinContent(13,10);
   HT_all->SetBinError(12,3.464102);
   HT_all->SetBinError(13,3.162278);
   ...
   HT_all->Draw("PSAME");
   u->Modified();
   canvasbtag_morethanzero_DiMuon_275_325/HT_all->cd();
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis5891[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis5891);
   HT_all->SetBinContent(12,0.1940764);
   HT_all->SetBinContent(13,0.21921);
   HT_all->SetBinError(12,0.3005685);
   HT_all->SetBinError(13,0.3300514);
   HT_all->SetMinimum(0);
   HT_all->SetMaximum(2);
   HT_all->SetEntries(20.77518);
   HT_all->SetLineWidth(2);
   HT_all->SetMarkerStyle(20);
   HT_all->SetMarkerSize(1.5);
   HT_all->GetXaxis()->SetRange(1,51);
   ...
   gre->SetPointError(11,12.5,0.08371442);
   gre->SetPoint(12,312.5,1);
   gre->SetPointError(12,12.5,0.09451955);
   ...
   TH1F *Graph_Graph_from_HT_all983 = new TH1F("Graph_Graph_from_HT_all983","",100,0,2750);
   Graph_Graph_from_HT_all983->SetMinimum(0.8865765);
   Graph_Graph_from_HT_all983->SetMaximum(1.113423);
   Graph_Graph_from_HT_all983->SetDirectory(0);
   Graph_Graph_from_HT_all983->SetStats(0);
   Graph_Graph_from_HT_all983->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all983->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all983->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all983->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all983->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all983->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all983->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all983->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all983->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all983->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all983);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,1270,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis5892[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis5892);
   HT_all->SetBinContent(12,0.1940764);
   HT_all->SetBinContent(13,0.21921);
   HT_all->SetBinError(12,0.3005685);
   HT_all->SetBinError(13,0.3300514);
   ...
   d->Modified();
   canvasbtag_morethanzero_DiMuon_275_325/HT_all->cd();
   canvasbtag_morethanzero_DiMuon_275_325/HT_all->Modified();
   canvasbtag_morethanzero_DiMuon_275_325/HT_all->cd();
   canvasbtag_morethanzero_DiMuon_275_325/HT_all->SetSelected(canvasbtag_morethanzero_DiMuon_275_325/HT_all);
}
