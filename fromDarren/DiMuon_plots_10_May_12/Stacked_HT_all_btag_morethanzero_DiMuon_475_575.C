...
//=========  (Thu May 10 12:47:08 2012) by ROOT version5.32/00
   TCanvas *canvasbtag_morethanzero_DiMuon_475_575/HT_all = new TCanvas("canvasbtag_morethanzero_DiMuon_475_575/HT_all", "cannameHT_all",1,1,1200,1176);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: u
   ...
   _stack_273->SetMinimum(0.002409911);
   _stack_273->SetMaximum(9.639643);
...
// ------------>Primitives in pad: d
   ...
   Graph_Graph_from_HT_all684->SetMinimum(0.560548);
   Graph_Graph_from_HT_all684->SetMaximum(1.439452);
