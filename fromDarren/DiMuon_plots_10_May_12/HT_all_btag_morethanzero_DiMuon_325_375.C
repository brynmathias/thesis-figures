{
//=========Macro generated from canvas: canvasbtag_morethanzero_DiMuon_325_375/HT_all/cannameHT_all
//=========  (Thu May 10 12:48:11 2012) by ROOT version5.32/00
   TCanvas *canvasbtag_morethanzero_DiMuon_325_375/HT_all = new TCanvas("canvasbtag_morethanzero_DiMuon_325_375/HT_all", "cannameHT_all",0,0,1200,1200);
   gStyle->SetOptStat(0);
   canvasbtag_morethanzero_DiMuon_325_375/HT_all->SetHighLightColor(2);
   canvasbtag_morethanzero_DiMuon_325_375/HT_all->Range(0,0,1,1);
   canvasbtag_morethanzero_DiMuon_325_375/HT_all->SetFillColor(0);
   canvasbtag_morethanzero_DiMuon_325_375/HT_all->SetBorderMode(0);
   canvasbtag_morethanzero_DiMuon_325_375/HT_all->SetBorderSize(2);
   canvasbtag_morethanzero_DiMuon_325_375/HT_all->SetTickx(1);
   canvasbtag_morethanzero_DiMuon_325_375/HT_all->SetTicky(1);
   canvasbtag_morethanzero_DiMuon_325_375/HT_all->SetFrameBorderMode(0);
  
// ------------>Primitives in pad: u
   TPad *u = new TPad("u", "u",0.01,0.25,0.99,0.99);
   u->Draw();
   u->cd();
   u->Range(-159.375,-0.6476989,1434.375,2.81899);
   u->SetFillColor(0);
   u->SetBorderMode(0);
   u->SetBorderSize(2);
   u->SetLogy();
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis6241[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis6241);
   HT_all->SetBinContent(14,7);
   HT_all->SetBinContent(15,9);
   HT_all->SetBinError(14,2.86);
   HT_all->SetBinError(15,3.19);
   HT_all->SetMinimum(0.5);
   HT_all->SetMaximum(296.7024);
   ...
   HT_all->Draw("PE0");
   Double_t xAxis6242[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis6242);
   HT_all->SetEntries(1);
   ...
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis6243);
   HT_all->SetBinContent(14,8.009851);
   HT_all->SetBinContent(15,9.408301);
   HT_all->SetBinError(14,1.507767);
   HT_all->SetBinError(15,2.147849);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis6244[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis6244);
   HT_all->SetEntries(1);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis6245[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis6245);
   HT_all->SetBinContent(14,20.23166);
   HT_all->SetBinContent(15,19.82886);
   HT_all->SetBinError(14,5.504265);
   HT_all->SetBinError(15,3.167268);
   HT_all->SetEntries(91);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis6246[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis6246);
   HT_all->SetBinContent(14,0.38312);
   HT_all->SetBinContent(15,0.2670411);
   HT_all->SetBinError(14,0.13931);
   HT_all->SetBinError(15,0.118203);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis6247[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis6247);
   HT_all->SetBinContent(14,0.310866);
   HT_all->SetBinContent(15,0.1660385);
   HT_all->SetBinError(14,0.05613846);
   HT_all->SetBinError(15,0.03688522);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis6248[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis6248);
   HT_all->SetEntries(1);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis6249[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis6249);
   HT_all->SetBinContent(14,28.9355);
   HT_all->SetBinContent(15,29.67024);
   HT_all->SetBinError(14,5.709015);
   HT_all->SetBinError(15,3.828861);
   HT_all->SetEntries(261);
   ...
   TH1F *Graph_Graph_from_HT_all1041 = new TH1F("Graph_Graph_from_HT_all1041","",100,0,2750);
   Graph_Graph_from_HT_all1041->SetMinimum(0.0011);
   Graph_Graph_from_HT_all1041->SetMaximum(1.1);
   Graph_Graph_from_HT_all1041->SetDirectory(0);
   Graph_Graph_from_HT_all1041->SetStats(0);
   Graph_Graph_from_HT_all1041->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all1041->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all1041->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all1041->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all1041->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all1041->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all1041->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all1041->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all1041->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all1041->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all1041);
   ...
   gre->SetPoint(12,312.5,0);
   gre->SetPointError(12,12.5,0);
   gre->SetPoint(13,337.5,28.9355);
   gre->SetPointError(13,12.5,5.709015);
   gre->SetPoint(14,362.5,29.67024);
   gre->SetPointError(14,12.5,3.828861);
   gre->SetPoint(15,387.5,0);
   gre->SetPointError(15,12.5,0);
   gre->SetPoint(16,412.5,0);
   gre->SetPointError(16,12.5,0);
   ...
   TH1F *Graph_Graph_from_HT_all1042 = new TH1F("Graph_Graph_from_HT_all1042","",100,0,2750);
   Graph_Graph_from_HT_all1042->SetMinimum(0.03810897);
   Graph_Graph_from_HT_all1042->SetMaximum(38.10897);
   Graph_Graph_from_HT_all1042->SetDirectory(0);
   Graph_Graph_from_HT_all1042->SetStats(0);
   Graph_Graph_from_HT_all1042->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all1042->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all1042->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all1042->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all1042->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all1042->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all1042->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all1042->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all1042->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all1042->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all1042);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis6250[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis6250);
   HT_all->SetBinContent(14,7);
   HT_all->SetBinContent(15,9);
   HT_all->SetBinError(14,2.86);
   HT_all->SetBinError(15,3.19);
   ...
   HT_all->Draw("PSAME");
   u->Modified();
   canvasbtag_morethanzero_DiMuon_325_375/HT_all->cd();
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis6251[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis6251);
   HT_all->SetBinContent(14,0.2419174);
   HT_all->SetBinContent(15,0.3033342);
   HT_all->SetBinError(14,0.4537163);
   HT_all->SetBinError(15,0.3772056);
   HT_all->SetMinimum(0);
   HT_all->SetMaximum(2);
   HT_all->SetEntries(12.82601);
   HT_all->SetLineWidth(2);
   HT_all->SetMarkerStyle(20);
   HT_all->SetMarkerSize(1.5);
   HT_all->GetXaxis()->SetRange(1,51);
   ...
   gre->SetPointError(13,12.5,0.1973014);
   gre->SetPoint(14,362.5,1);
   gre->SetPointError(14,12.5,0.1290472);
   ...
   TH1F *Graph_Graph_from_HT_all1043 = new TH1F("Graph_Graph_from_HT_all1043","",100,0,2750);
   Graph_Graph_from_HT_all1043->SetMinimum(0.7632383);
   Graph_Graph_from_HT_all1043->SetMaximum(1.236762);
   Graph_Graph_from_HT_all1043->SetDirectory(0);
   Graph_Graph_from_HT_all1043->SetStats(0);
   Graph_Graph_from_HT_all1043->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all1043->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all1043->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all1043->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all1043->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all1043->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all1043->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all1043->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all1043->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all1043->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all1043);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,1270,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis6252[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis6252);
   HT_all->SetBinContent(14,0.2419174);
   HT_all->SetBinContent(15,0.3033342);
   HT_all->SetBinError(14,0.4537163);
   HT_all->SetBinError(15,0.3772056);
   ...
   d->Modified();
   canvasbtag_morethanzero_DiMuon_325_375/HT_all->cd();
   canvasbtag_morethanzero_DiMuon_325_375/HT_all->Modified();
   canvasbtag_morethanzero_DiMuon_325_375/HT_all->cd();
   canvasbtag_morethanzero_DiMuon_325_375/HT_all->SetSelected(canvasbtag_morethanzero_DiMuon_325_375/HT_all);
}
