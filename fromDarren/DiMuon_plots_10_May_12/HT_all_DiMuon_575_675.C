{
//=========Macro generated from canvas: canvasDiMuon_575_675/HT_all/cannameHT_all
//=========  (Thu May 10 12:45:34 2012) by ROOT version5.32/00
   TCanvas *canvasDiMuon_575_675/HT_all = new TCanvas("canvasDiMuon_575_675/HT_all", "cannameHT_all",0,0,1200,1200);
   gStyle->SetOptStat(0);
   canvasDiMuon_575_675/HT_all->SetHighLightColor(2);
   canvasDiMuon_575_675/HT_all->Range(0,0,1,1);
   canvasDiMuon_575_675/HT_all->SetFillColor(0);
   canvasDiMuon_575_675/HT_all->SetBorderMode(0);
   canvasDiMuon_575_675/HT_all->SetBorderSize(2);
   canvasDiMuon_575_675/HT_all->SetTickx(1);
   canvasDiMuon_575_675/HT_all->SetTicky(1);
   canvasDiMuon_575_675/HT_all->SetFrameBorderMode(0);
  
// ------------>Primitives in pad: u
   TPad *u = new TPad("u", "u",0.01,0.25,0.99,0.99);
   u->Draw();
   u->cd();
   u->Range(-159.375,-0.641768,1434.375,2.765612);
   u->SetFillColor(0);
   u->SetBorderMode(0);
   u->SetBorderSize(2);
   u->SetLogy();
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis1201[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis1201);
   ...
   HT_all->Draw("PE0");
   Double_t xAxis1202[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis1202);
   HT_all->SetEntries(1);
   ...
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis1203);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis1204[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis1204);
   HT_all->SetEntries(1);
   ...
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis1205);
   ...
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis1206);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis1207[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis1207);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis1208[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis1208);
   HT_all->SetEntries(1);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis1209[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis1209);
   ...
   TH1F *Graph_Graph_from_HT_all201 = new TH1F("Graph_Graph_from_HT_all201","",100,0,2750);
   Graph_Graph_from_HT_all201->SetMinimum(0.0011);
   Graph_Graph_from_HT_all201->SetMaximum(1.1);
   Graph_Graph_from_HT_all201->SetDirectory(0);
   Graph_Graph_from_HT_all201->SetStats(0);
   Graph_Graph_from_HT_all201->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all201->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all201->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all201->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all201->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all201->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all201->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all201->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all201->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all201->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all201);
   ...
   TH1F *Graph_Graph_from_HT_all202 = new TH1F("Graph_Graph_from_HT_all202","",100,0,2750);
   Graph_Graph_from_HT_all202->SetMinimum(0.03343716);
   Graph_Graph_from_HT_all202->SetMaximum(33.43716);
   Graph_Graph_from_HT_all202->SetDirectory(0);
   Graph_Graph_from_HT_all202->SetStats(0);
   Graph_Graph_from_HT_all202->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all202->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all202->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all202->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all202->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all202->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all202->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all202->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all202->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all202->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all202);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis1210[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis1210);
   HT_all->SetBinContent(24,7);
   HT_all->SetBinContent(25,11);
   HT_all->SetBinContent(26,4);
   HT_all->SetBinContent(27,4);
   ...
   HT_all->Draw("PSAME");
   u->Modified();
   canvasDiMuon_575_675/HT_all->cd();
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis1211[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis1211);
   ...
   TH1F *Graph_Graph_from_HT_all203 = new TH1F("Graph_Graph_from_HT_all203","",100,0,2750);
   Graph_Graph_from_HT_all203->SetMinimum(0.7497612);
   Graph_Graph_from_HT_all203->SetMaximum(1.250239);
   Graph_Graph_from_HT_all203->SetDirectory(0);
   Graph_Graph_from_HT_all203->SetStats(0);
   Graph_Graph_from_HT_all203->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all203->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all203->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all203->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all203->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all203->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all203->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all203->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all203->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all203->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all203);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,1270,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis1212[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis1212);
   HT_all->SetBinContent(24,0.2631628);
   HT_all->SetBinContent(25,0.5669475);
   HT_all->SetBinContent(26,0.270975);
   HT_all->SetBinContent(27,0.3769292);
   ...
   d->Modified();
   canvasDiMuon_575_675/HT_all->cd();
   canvasDiMuon_575_675/HT_all->Modified();
   canvasDiMuon_575_675/HT_all->cd();
   canvasDiMuon_575_675/HT_all->SetSelected(canvasDiMuon_575_675/HT_all);
}
