...
// ------------>Primitives in pad: u
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis6474[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Post_AlphaT_5_55_all = new TH1D("Btag_Post_AlphaT_5_55_all","",6, xAxis6474);
   ...
   Double_t xAxis6475[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Post_AlphaT_5_55_all = new TH1D("Btag_Post_AlphaT_5_55_all","",6, xAxis6475);
   ...
   TH1F *_stack_432 = new TH1F("_stack_432","",6,0,6);
   _stack_432->SetMinimum(0.004013053);
   _stack_432->SetMaximum(16.05221);
   ...
   Double_t xAxis6476[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Post_AlphaT_5_55_all = new TH1D("Btag_Post_AlphaT_5_55_all","",6, xAxis6476);
   ...
   Double_t xAxis6477[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Post_AlphaT_5_55_all = new TH1D("Btag_Post_AlphaT_5_55_all","",6, xAxis6477);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis6478[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Post_AlphaT_5_55_all = new TH1D("Btag_Post_AlphaT_5_55_all","",6, xAxis6478);
   Btag_Post_AlphaT_5_55_all->SetBinContent(2,9);
   Btag_Post_AlphaT_5_55_all->SetBinContent(3,3);
   Btag_Post_AlphaT_5_55_all->SetBinError(2,3.19);
   Btag_Post_AlphaT_5_55_all->SetBinError(3,2.14);
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis6479[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Post_AlphaT_5_55_all = new TH1D("Btag_Post_AlphaT_5_55_all","",6, xAxis6479);
   ...
   TH1F *Graph_Graph_from_Btag_Post_AlphaT_5_55_all1080 = new TH1F("Graph_Graph_from_Btag_Post_AlphaT_5_55_all1080","",100,0,6.6);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all1080->SetMinimum(0);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all1080->SetMaximum(2.085295);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all1080->SetDirectory(0);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all1080->SetStats(0);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all1080->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all1080->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all1080->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all1080->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all1080->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all1080->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all1080->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all1080->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all1080->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_Btag_Post_AlphaT_5_55_all1080->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_Btag_Post_AlphaT_5_55_all1080);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,6,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis6480[7] = {0, 1, 2, 3, 4, 5, 6}; 
   
   TH1D *Btag_Post_AlphaT_5_55_all = new TH1D("Btag_Post_AlphaT_5_55_all","",6, xAxis6480);
   Btag_Post_AlphaT_5_55_all->SetBinContent(2,1.25961);
   Btag_Post_AlphaT_5_55_all->SetBinContent(3,0.5694655);
   Btag_Post_AlphaT_5_55_all->SetBinError(2,0.4416118);
   Btag_Post_AlphaT_5_55_all->SetBinError(3,1.151871);
