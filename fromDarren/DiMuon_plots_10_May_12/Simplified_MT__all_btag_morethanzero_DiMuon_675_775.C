...
// ------------>Primitives in pad: u
   ...
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis4974);
   ...
   MT__all->Draw("");
   Double_t xAxis4975[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis4975);
   ...
   TH1F *_stack_332 = new TH1F("_stack_332","",100,0,2000);
   _stack_332->SetMinimum(0.0008572247);
   _stack_332->SetMaximum(3.428899);
   ...
   Double_t xAxis4976[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis4976);
   ...
   MT__all->GetXaxis()->SetRange(1,41);
   ->Add(MT__all,"");
   Double_t xAxis4977[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis4977);
   MT__all->SetEntries(1);
...
tex->SetNDC();
   ...
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis4978);
   MT__all->SetBinContent(3,1);
   MT__all->SetBinContent(4,3);
   MT__all->SetBinContent(5,2);
   MT__all->SetBinContent(7,2);
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis4979[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis4979);
   ...
   TH1F *Graph_Graph_from_MT__all830 = new TH1F("Graph_Graph_from_MT__all830","",100,0,2200);
   Graph_Graph_from_MT__all830->SetMinimum(-0.2);
   Graph_Graph_from_MT__all830->SetMaximum(2.2);
   Graph_Graph_from_MT__all830->SetDirectory(0);
   Graph_Graph_from_MT__all830->SetStats(0);
   Graph_Graph_from_MT__all830->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all830->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all830->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MT__all830->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_MT__all830->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all830->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all830->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MT__all830->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all830->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all830->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_MT__all830);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,820,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis4980[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis4980);
   MT__all->SetBinContent(3,7.57975);
   MT__all->SetBinContent(4,4.57027);
   MT__all->SetBinContent(5,8.498143);
   MT__all->SetBinError(3,1.197571);
