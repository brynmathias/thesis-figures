...
//=========  (Thu May 10 12:47:18 2012) by ROOT version5.32/00
   TCanvas *canvasbtag_morethanzero_DiMuon_575_675/HT_all = new TCanvas("canvasbtag_morethanzero_DiMuon_575_675/HT_all", "cannameHT_all",0,0,1200,1200);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: u
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis4441[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis4441);
   ...
   HT_all->Draw("PE0");
   Double_t xAxis4442[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis4442);
   HT_all->SetEntries(1);
   ...
   Double_t xAxis4443[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis4443);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis4444[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis4444);
   HT_all->SetEntries(1);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis4445[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis4445);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis4446[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis4446);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis4447[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis4447);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis4448[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis4448);
   HT_all->SetEntries(1);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis4449[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis4449);
   ...
   TH1F *Graph_Graph_from_HT_all741 = new TH1F("Graph_Graph_from_HT_all741","",100,0,2750);
   Graph_Graph_from_HT_all741->SetMinimum(0.0011);
   Graph_Graph_from_HT_all741->SetMaximum(1.1);
   Graph_Graph_from_HT_all741->SetDirectory(0);
   Graph_Graph_from_HT_all741->SetStats(0);
   Graph_Graph_from_HT_all741->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all741->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all741->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all741->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all741->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all741->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all741->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all741->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all741->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all741->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all741);
   ...
   TH1F *Graph_Graph_from_HT_all742 = new TH1F("Graph_Graph_from_HT_all742","",100,0,2750);
   Graph_Graph_from_HT_all742->SetMinimum(0.005380227);
   Graph_Graph_from_HT_all742->SetMaximum(5.380227);
   Graph_Graph_from_HT_all742->SetDirectory(0);
   Graph_Graph_from_HT_all742->SetStats(0);
   Graph_Graph_from_HT_all742->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all742->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all742->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all742->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all742->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all742->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all742->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all742->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all742->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all742->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all742);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis4450[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis4450);
   HT_all->SetBinContent(24,5);
   HT_all->SetBinContent(25,6);
   HT_all->SetBinContent(26,4);
   HT_all->SetBinError(24,2.49);
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis4451[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis4451);
   ...
   TH1F *Graph_Graph_from_HT_all743 = new TH1F("Graph_Graph_from_HT_all743","",100,0,2750);
   Graph_Graph_from_HT_all743->SetMinimum(0.2915368);
   Graph_Graph_from_HT_all743->SetMaximum(1.708463);
   Graph_Graph_from_HT_all743->SetDirectory(0);
   Graph_Graph_from_HT_all743->SetStats(0);
   Graph_Graph_from_HT_all743->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all743->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all743->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all743->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all743->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all743->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all743->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all743->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all743->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all743->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all743);
   ...
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis4452);
   HT_all->SetBinContent(24,1.379049);
   HT_all->SetBinContent(25,1.704427);
   HT_all->SetBinContent(26,3.252396);
   HT_all->SetBinError(24,0.5991133);
