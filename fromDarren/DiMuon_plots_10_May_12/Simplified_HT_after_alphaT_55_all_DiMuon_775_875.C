...
//=========  (Thu May 10 12:45:55 2012) by ROOT version5.32/00
   TCanvas *canvasDiMuon_775_875/HT_after_alphaT_55_all = new TCanvas("canvasDiMuon_775_875/HT_after_alphaT_55_all", "cannameHT_after_alphaT_55_all",1,1,1200,1176);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: u
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis1914[81] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000}; 
   
   TH1D *HT_after_alphaT_55_all = new TH1D("HT_after_alphaT_55_all","",80, xAxis1914);
   ...
   Double_t xAxis1915[81] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000}; 
   
   TH1D *HT_after_alphaT_55_all = new TH1D("HT_after_alphaT_55_all","",80, xAxis1915);
   HT_after_alphaT_55_all->SetEntries(1);
   ...
   TH1F *_stack_128 = new TH1F("_stack_128","",80,0,2000);
   _stack_128->SetMinimum(0.0001194877);
   _stack_128->SetMaximum(0.4779507);
   ...
   Double_t xAxis1916[81] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000}; 
   
   TH1D *HT_after_alphaT_55_all = new TH1D("HT_after_alphaT_55_all","",80, xAxis1916);
   ...
   Double_t xAxis1917[81] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000}; 
   
   TH1D *HT_after_alphaT_55_all = new TH1D("HT_after_alphaT_55_all","",80, xAxis1917);
   HT_after_alphaT_55_all->SetEntries(1);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis1918[81] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000}; 
   
   TH1D *HT_after_alphaT_55_all = new TH1D("HT_after_alphaT_55_all","",80, xAxis1918);
   HT_after_alphaT_55_all->SetMinimum(0.5);
   HT_after_alphaT_55_all->SetMaximum(1.493596);
   HT_after_alphaT_55_all->SetEntries(1);
   HT_after_alphaT_55_all->SetLineWidth(2);
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis1919[81] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000}; 
   
   TH1D *HT_after_alphaT_55_all = new TH1D("HT_after_alphaT_55_all","",80, xAxis1919);
   ...
   TH1F *Graph_Graph_from_HT_after_alphaT_55_all320 = new TH1F("Graph_Graph_from_HT_after_alphaT_55_all320","",100,0,2200);
   Graph_Graph_from_HT_after_alphaT_55_all320->SetMinimum(0);
   Graph_Graph_from_HT_after_alphaT_55_all320->SetMaximum(2.2);
   Graph_Graph_from_HT_after_alphaT_55_all320->SetDirectory(0);
   Graph_Graph_from_HT_after_alphaT_55_all320->SetStats(0);
   Graph_Graph_from_HT_after_alphaT_55_all320->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_after_alphaT_55_all320->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_after_alphaT_55_all320->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_after_alphaT_55_all320->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_after_alphaT_55_all320->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_after_alphaT_55_all320->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_after_alphaT_55_all320->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_after_alphaT_55_all320->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_after_alphaT_55_all320->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_after_alphaT_55_all320->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_after_alphaT_55_all320);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,1275,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis1920[81] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000}; 
   
   TH1D *HT_after_alphaT_55_all = new TH1D("HT_after_alphaT_55_all","",80, xAxis1920);
   HT_after_alphaT_55_all->SetMinimum(0);
   HT_after_alphaT_55_all->SetMaximum(2);
   HT_after_alphaT_55_all->SetLineWidth(2);
   HT_after_alphaT_55_all->SetMarkerStyle(20);
