...
//=========  (Thu May 10 12:46:15 2012) by ROOT version5.32/00
   TCanvas *canvasDiMuon_275_325/EffectiveMass_after_alphaT_55_all = new TCanvas("canvasDiMuon_275_325/EffectiveMass_after_alphaT_55_all", "cannameEffectiveMass_after_alphaT_55_all",0,0,1200,1200);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: u
   ...
   Double_t xAxis2582[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis2582);
   ...
   Double_t xAxis2583[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis2583);
   ...
   EffectiveMass_after_alphaT_55_all->GetYaxis()->SetTitle(" Events/40 GeV");
   EffectiveMass_after_alphaT_55_all->Draw("HISTSAME");
   Double_t xAxis2584[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis2584);
   EffectiveMass_after_alphaT_55_all->SetEntries(1);
   ...
   EffectiveMass_after_alphaT_55_all->GetYaxis()->SetTitle(" Events/40 GeV");
   EffectiveMass_after_alphaT_55_all->Draw("HISTSAME");
   Double_t xAxis2585[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis2585);
   ...
   EffectiveMass_after_alphaT_55_all->GetYaxis()->SetTitle(" Events/40 GeV");
   EffectiveMass_after_alphaT_55_all->Draw("HISTSAME");
   Double_t xAxis2586[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis2586);
   ...
   EffectiveMass_after_alphaT_55_all->GetYaxis()->SetTitle(" Events/40 GeV");
   EffectiveMass_after_alphaT_55_all->Draw("HISTSAME");
   Double_t xAxis2587[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis2587);
   ...
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis2588);
   EffectiveMass_after_alphaT_55_all->SetEntries(1);
   ...
   EffectiveMass_after_alphaT_55_all->GetYaxis()->SetTitle(" Events/40 GeV");
   EffectiveMass_after_alphaT_55_all->Draw("HISTSAME");
   Double_t xAxis2589[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis2589);
   EffectiveMass_after_alphaT_55_all->SetBinContent(11,7.552908);
   EffectiveMass_after_alphaT_55_all->SetBinContent(12,22.7087);
   EffectiveMass_after_alphaT_55_all->SetBinContent(13,46.79879);
   EffectiveMass_after_alphaT_55_all->SetBinContent(14,32.35673);
   EffectiveMass_after_alphaT_55_all->SetBinContent(15,25.85986);
   EffectiveMass_after_alphaT_55_all->SetBinContent(16,7.737382);
   EffectiveMass_after_alphaT_55_all->SetBinContent(17,0.4071855);
   EffectiveMass_after_alphaT_55_all->SetBinError(11,1.828368);
   EffectiveMass_after_alphaT_55_all->SetBinError(12,3.168441);
   EffectiveMass_after_alphaT_55_all->SetBinError(13,4.883837);
   EffectiveMass_after_alphaT_55_all->SetBinError(14,4.089706);
   EffectiveMass_after_alphaT_55_all->SetBinError(15,3.573907);
   EffectiveMass_after_alphaT_55_all->SetBinError(16,1.827414);
   EffectiveMass_after_alphaT_55_all->SetBinError(17,0.4071855);
   EffectiveMass_after_alphaT_55_all->SetEntries(677);
   ...
   TH1F *Graph_Graph_from_EffectiveMass_after_alphaT_55_all431 = new TH1F("Graph_Graph_from_EffectiveMass_after_alphaT_55_all431","",100,0,3300);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all431->SetMinimum(0.0011);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all431->SetMaximum(1.1);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all431->SetDirectory(0);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all431->SetStats(0);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all431->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all431->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all431->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all431->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all431->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all431->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all431->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all431->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all431->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all431->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_EffectiveMass_after_alphaT_55_all431);
   ...
   gre->SetPoint(9,380,0);
   gre->SetPointError(9,20,0);
   gre->SetPoint(10,420,7.552908);
   gre->SetPointError(10,20,1.828368);
   gre->SetPoint(11,460,22.7087);
   gre->SetPointError(11,20,3.168441);
   gre->SetPoint(12,500,46.79879);
   gre->SetPointError(12,20,4.883837);
   gre->SetPoint(13,540,32.35673);
   gre->SetPointError(13,20,4.089706);
   gre->SetPoint(14,580,25.85986);
   gre->SetPointError(14,20,3.573907);
   ...
   TH1F *Graph_Graph_from_EffectiveMass_after_alphaT_55_all432 = new TH1F("Graph_Graph_from_EffectiveMass_after_alphaT_55_all432","",100,0,3300);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all432->SetMinimum(0.05685088);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all432->SetMaximum(56.85088);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all432->SetDirectory(0);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all432->SetStats(0);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all432->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all432->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all432->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all432->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all432->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all432->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all432->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all432->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all432->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all432->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_EffectiveMass_after_alphaT_55_all432);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis2590[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis2590);
   EffectiveMass_after_alphaT_55_all->SetBinContent(11,7);
   EffectiveMass_after_alphaT_55_all->SetBinContent(12,18);
   EffectiveMass_after_alphaT_55_all->SetBinContent(13,24);
   EffectiveMass_after_alphaT_55_all->SetBinContent(14,31);
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis2591[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis2591);
   ...
   TH1F *Graph_Graph_from_EffectiveMass_after_alphaT_55_all433 = new TH1F("Graph_Graph_from_EffectiveMass_after_alphaT_55_all433","",100,0,3300);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all433->SetMinimum(-0.2);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all433->SetMaximum(2.2);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all433->SetDirectory(0);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all433->SetStats(0);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all433->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all433->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all433->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all433->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all433->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all433->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all433->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all433->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all433->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_EffectiveMass_after_alphaT_55_all433->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_EffectiveMass_after_alphaT_55_all433);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,1640,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis2592[76] = {0, 40, 80, 120, 160, 200, 240, 280, 320, 360, 400, 440, 480, 520, 560, 600, 640, 680, 720, 760, 800, 840, 880, 920, 960, 1000, 1040, 1080, 1120, 1160, 1200, 1240, 1280, 1320, 1360, 1400, 1440, 1480, 1520, 1560, 1600, 1640, 1680, 1720, 1760, 1800, 1840, 1880, 1920, 1960, 2000, 2040, 2080, 2120, 2160, 2200, 2240, 2280, 2320, 2360, 2400, 2440, 2480, 2520, 2560, 2600, 2640, 2680, 2720, 2760, 2800, 2840, 2880, 2920, 2960, 3000}; 
   
   TH1D *EffectiveMass_after_alphaT_55_all = new TH1D("EffectiveMass_after_alphaT_55_all","",75, xAxis2592);
   EffectiveMass_after_alphaT_55_all->SetBinContent(11,0.9267954);
   EffectiveMass_after_alphaT_55_all->SetBinContent(12,0.7926479);
   EffectiveMass_after_alphaT_55_all->SetBinContent(13,0.5128338);
   EffectiveMass_after_alphaT_55_all->SetBinContent(14,0.9580695);
