...
//=========  (Thu May 10 12:46:47 2012) by ROOT version5.32/00
...
// ------------>Primitives in pad: u
   ...
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3481);
   ...
   HT_all->Draw("PE0");
   Double_t xAxis3482[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3482);
   ...
   Double_t xAxis3483[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3483);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis3484[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3484);
   HT_all->SetEntries(1);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis3485[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3485);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis3486[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3486);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis3487[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3487);
   ...
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3488);
   HT_all->SetEntries(1);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis3489[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3489);
   ...
   TH1F *Graph_Graph_from_HT_all581 = new TH1F("Graph_Graph_from_HT_all581","",100,0,2750);
   Graph_Graph_from_HT_all581->SetMinimum(0.0011);
   Graph_Graph_from_HT_all581->SetMaximum(1.1);
   Graph_Graph_from_HT_all581->SetDirectory(0);
   Graph_Graph_from_HT_all581->SetStats(0);
   Graph_Graph_from_HT_all581->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all581->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all581->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all581->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all581->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all581->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all581->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all581->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all581->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all581->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all581);
   ...
   TH1F *Graph_Graph_from_HT_all582 = new TH1F("Graph_Graph_from_HT_all582","",100,0,2750);
   Graph_Graph_from_HT_all582->SetMinimum(0.02063446);
   Graph_Graph_from_HT_all582->SetMaximum(20.63446);
   Graph_Graph_from_HT_all582->SetDirectory(0);
   Graph_Graph_from_HT_all582->SetStats(0);
   Graph_Graph_from_HT_all582->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all582->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all582->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all582->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all582->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all582->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all582->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all582->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all582->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all582->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all582);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis3490[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3490);
   HT_all->SetBinContent(16,13);
   HT_all->SetBinContent(17,14);
   HT_all->SetBinContent(18,11);
   HT_all->SetBinContent(19,5);
...
// ------------>Primitives in pad: d
   ...
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3491);
   ...
   TH1F *Graph_Graph_from_HT_all583 = new TH1F("Graph_Graph_from_HT_all583","",100,0,2750);
   Graph_Graph_from_HT_all583->SetMinimum(0.7298196);
   Graph_Graph_from_HT_all583->SetMaximum(1.27018);
   Graph_Graph_from_HT_all583->SetDirectory(0);
   Graph_Graph_from_HT_all583->SetStats(0);
   Graph_Graph_from_HT_all583->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all583->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all583->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all583->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all583->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all583->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all583->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all583->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all583->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all583->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all583);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,1270,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis3492[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3492);
   HT_all->SetBinContent(16,0.8172429);
   HT_all->SetBinContent(17,1.676065);
   HT_all->SetBinContent(18,1.235882);
   HT_all->SetBinContent(19,0.5814171);
