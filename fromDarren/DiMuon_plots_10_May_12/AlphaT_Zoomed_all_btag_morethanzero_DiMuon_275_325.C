...
//=========  (Thu May 10 12:47:55 2012) by ROOT version5.32/00
   TCanvas *canvasbtag_morethanzero_DiMuon_275_325/AlphaT_Zoomed_all = new TCanvas("canvasbtag_morethanzero_DiMuon_275_325/AlphaT_Zoomed_all", "cannameAlphaT_Zoomed_all",0,0,1200,1200);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: u
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis5791[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5791);
   ...
   Double_t xAxis5792[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5792);
   ...
   Double_t xAxis5793[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5793);
   ...
   AlphaT_Zoomed_all->GetYaxis()->SetTitle(" Events/0.0025");
   AlphaT_Zoomed_all->Draw("HISTSAME");
   Double_t xAxis5794[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5794);
   AlphaT_Zoomed_all->SetLineColor(5);
   AlphaT_Zoomed_all->SetLineWidth(3);
   AlphaT_Zoomed_all->GetXaxis()->SetTitle("#alpha_{T}");
   AlphaT_Zoomed_all->GetYaxis()->SetTitle(" Events/0.0025");
   AlphaT_Zoomed_all->Draw("HISTSAME");
   Double_t xAxis5795[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5795);
   ...
   AlphaT_Zoomed_all->GetYaxis()->SetTitle(" Events/0.0025");
   AlphaT_Zoomed_all->Draw("HISTSAME");
   Double_t xAxis5796[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5796);
   ...
   AlphaT_Zoomed_all->GetYaxis()->SetTitle(" Events/0.0025");
   AlphaT_Zoomed_all->Draw("HISTSAME");
   Double_t xAxis5797[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5797);
   ...
   AlphaT_Zoomed_all->GetYaxis()->SetTitle(" Events/0.0025");
   AlphaT_Zoomed_all->Draw("HISTSAME");
   Double_t xAxis5798[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5798);
   ...
   AlphaT_Zoomed_all->GetYaxis()->SetTitle(" Events/0.0025");
   AlphaT_Zoomed_all->Draw("HISTSAME");
   Double_t xAxis5799[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5799);
   ...
   TH1F *Graph_Graph_from_AlphaT_Zoomed_all966 = new TH1F("Graph_Graph_from_AlphaT_Zoomed_all966","",100,0.435,0.615);
   Graph_Graph_from_AlphaT_Zoomed_all966->SetMinimum(0.0011);
   Graph_Graph_from_AlphaT_Zoomed_all966->SetMaximum(1.1);
   Graph_Graph_from_AlphaT_Zoomed_all966->SetDirectory(0);
   Graph_Graph_from_AlphaT_Zoomed_all966->SetStats(0);
   Graph_Graph_from_AlphaT_Zoomed_all966->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_AlphaT_Zoomed_all966->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_AlphaT_Zoomed_all966->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_AlphaT_Zoomed_all966->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_AlphaT_Zoomed_all966->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_AlphaT_Zoomed_all966->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_AlphaT_Zoomed_all966->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_AlphaT_Zoomed_all966->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_AlphaT_Zoomed_all966->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_AlphaT_Zoomed_all966->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_AlphaT_Zoomed_all966);
   ...
   gre->SetLineColor(4);
   gre->SetLineWidth(3);
   gre->SetPoint(0,0.45625,7.221347);
   gre->SetPointError(0,0.00625,1.662414);
   gre->SetPoint(1,0.46875,5.185063);
   gre->SetPointError(1,0.00625,1.395397);
   gre->SetPoint(2,0.48125,7.29299);
   gre->SetPointError(2,0.00625,1.697116);
   gre->SetPoint(3,0.49375,9.60893);
   gre->SetPointError(3,0.00625,2.035944);
   gre->SetPoint(4,0.50625,5.893239);
   gre->SetPointError(4,0.00625,1.580685);
   gre->SetPoint(5,0.51875,6.853379);
   gre->SetPointError(5,0.00625,1.694959);
   gre->SetPoint(6,0.53125,4.987991);
   gre->SetPointError(6,0.00625,1.43106);
   gre->SetPoint(7,0.54375,3.977492);
   gre->SetPointError(7,0.00625,1.271238);
   gre->SetPoint(8,0.55625,3.628687);
   gre->SetPointError(8,0.00625,1.217415);
   gre->SetPoint(9,0.56875,2.598191);
   gre->SetPointError(9,0.00625,1.048783);
   gre->SetPoint(10,0.58125,2.550836);
   gre->SetPointError(10,0.00625,1.185843);
   gre->SetPoint(11,0.59375,2.023972);
   gre->SetPointError(11,0.00625,0.8969523);
   
   TH1F *Graph_Graph_from_AlphaT_Zoomed_all967 = new TH1F("Graph_Graph_from_AlphaT_Zoomed_all967","",100,0.435,0.615);
   Graph_Graph_from_AlphaT_Zoomed_all967->SetMinimum(0.07523405);
   Graph_Graph_from_AlphaT_Zoomed_all967->SetMaximum(12.69666);
   Graph_Graph_from_AlphaT_Zoomed_all967->SetDirectory(0);
   Graph_Graph_from_AlphaT_Zoomed_all967->SetStats(0);
   Graph_Graph_from_AlphaT_Zoomed_all967->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_AlphaT_Zoomed_all967->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_AlphaT_Zoomed_all967->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_AlphaT_Zoomed_all967->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_AlphaT_Zoomed_all967->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_AlphaT_Zoomed_all967->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_AlphaT_Zoomed_all967->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_AlphaT_Zoomed_all967->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_AlphaT_Zoomed_all967->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_AlphaT_Zoomed_all967->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_AlphaT_Zoomed_all967);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis5800[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5800);
   AlphaT_Zoomed_all->SetBinContent(7,3);
   AlphaT_Zoomed_all->SetBinContent(9,7);
   AlphaT_Zoomed_all->SetBinContent(10,2);
   AlphaT_Zoomed_all->SetBinContent(11,1);
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis5801[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5801);
   ...
   TH1F *Graph_Graph_from_AlphaT_Zoomed_all968 = new TH1F("Graph_Graph_from_AlphaT_Zoomed_all968","",100,0.435,0.615);
   Graph_Graph_from_AlphaT_Zoomed_all968->SetMinimum(0.4421392);
   Graph_Graph_from_AlphaT_Zoomed_all968->SetMaximum(1.557861);
   Graph_Graph_from_AlphaT_Zoomed_all968->SetDirectory(0);
   Graph_Graph_from_AlphaT_Zoomed_all968->SetStats(0);
   Graph_Graph_from_AlphaT_Zoomed_all968->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_AlphaT_Zoomed_all968->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_AlphaT_Zoomed_all968->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_AlphaT_Zoomed_all968->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_AlphaT_Zoomed_all968->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_AlphaT_Zoomed_all968->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_AlphaT_Zoomed_all968->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_AlphaT_Zoomed_all968->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_AlphaT_Zoomed_all968->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_AlphaT_Zoomed_all968->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_AlphaT_Zoomed_all968);
   
   gre->Draw("2");
   TLine *line = new TLine(0.45,1,0.6,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis5802[13] = {0.45, 0.4625, 0.475, 0.4875, 0.5, 0.5125, 0.525, 0.5375, 0.55, 0.5625, 0.575, 0.5875, 0.6}; 
   
   TH1D *AlphaT_Zoomed_all = new TH1D("AlphaT_Zoomed_all","",12, xAxis5802);
   AlphaT_Zoomed_all->SetBinContent(7,0.6014445);
   AlphaT_Zoomed_all->SetBinContent(9,1.929073);
   AlphaT_Zoomed_all->SetBinContent(10,0.7697663);
   AlphaT_Zoomed_all->SetBinContent(11,0.3920284);
