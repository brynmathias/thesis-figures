{
//=========Macro generated from canvas: canvasDiMuon_325_375/HT_all/cannameHT_all
//=========  (Thu May 10 12:46:29 2012) by ROOT version5.32/00
   TCanvas *canvasDiMuon_325_375/HT_all = new TCanvas("canvasDiMuon_325_375/HT_all", "cannameHT_all",0,0,1200,1200);
   gStyle->SetOptStat(0);
   canvasDiMuon_325_375/HT_all->SetHighLightColor(2);
   canvasDiMuon_325_375/HT_all->Range(0,0,1,1);
   canvasDiMuon_325_375/HT_all->SetFillColor(0);
   canvasDiMuon_325_375/HT_all->SetBorderMode(0);
   canvasDiMuon_325_375/HT_all->SetBorderSize(2);
   canvasDiMuon_325_375/HT_all->SetTickx(1);
   canvasDiMuon_325_375/HT_all->SetTicky(1);
   canvasDiMuon_325_375/HT_all->SetFrameBorderMode(0);
  
// ------------>Primitives in pad: u
   TPad *u = new TPad("u", "u",0.01,0.25,0.99,0.99);
   u->Draw();
   u->cd();
   u->Range(-159.375,-0.7549183,1434.375,3.783965);
   u->SetFillColor(0);
   u->SetBorderMode(0);
   u->SetBorderSize(2);
   u->SetLogy();
   ...
   u->SetFrameBorderMode(0);
   Double_t xAxis3001[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3001);
   HT_all->SetBinContent(14,47);
   HT_all->SetBinContent(15,52);
   HT_all->SetBinError(14,6.855655);
   HT_all->SetBinError(15,7.211103);
   HT_all->SetMinimum(0.5);
   HT_all->SetMaximum(2138.338);
   HT_all->SetEntries(100);
   ...
   HT_all->Draw("PE0");
   Double_t xAxis3002[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3002);
   HT_all->SetEntries(1);
   ...
   Double_t xAxis3003[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3003);
   HT_all->SetBinContent(14,9.119792);
   HT_all->SetBinContent(15,9.921473);
   HT_all->SetBinError(14,1.584703);
   HT_all->SetBinError(15,2.178297);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis3004[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3004);
   HT_all->SetEntries(1);
   ...
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3005);
   HT_all->SetBinContent(14,202.7207);
   HT_all->SetBinContent(15,153.9929);
   HT_all->SetBinError(14,11.60055);
   HT_all->SetBinError(15,9.037738);
   HT_all->SetEntries(886);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis3006[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3006);
   HT_all->SetBinContent(14,0.4650831);
   HT_all->SetBinContent(15,0.3411172);
   HT_all->SetBinError(14,0.1476241);
   HT_all->SetBinError(15,0.1322243);
   ...
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3007);
   HT_all->SetBinContent(14,1.528185);
   HT_all->SetBinContent(15,1.027395);
   HT_all->SetBinError(14,0.1395145);
   HT_all->SetBinError(15,0.1027158);
   HT_all->SetEntries(305);
   ...
   HT_all->GetYaxis()->SetTitle(" Events/25 GeV");
   HT_all->Draw("HISTSAME");
   Double_t xAxis3008[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3008);
   HT_all->SetEntries(1);
   ...
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3009);
   HT_all->SetBinContent(14,213.8338);
   HT_all->SetBinContent(15,165.2829);
   HT_all->SetBinError(14,11.71005);
   HT_all->SetBinError(15,9.298049);
   HT_all->SetEntries(1309);
   ...
   TH1F *Graph_Graph_from_HT_all501 = new TH1F("Graph_Graph_from_HT_all501","",100,0,2750);
   Graph_Graph_from_HT_all501->SetMinimum(0.0011);
   Graph_Graph_from_HT_all501->SetMaximum(1.1);
   Graph_Graph_from_HT_all501->SetDirectory(0);
   Graph_Graph_from_HT_all501->SetStats(0);
   Graph_Graph_from_HT_all501->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all501->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all501->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all501->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all501->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all501->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all501->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all501->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all501->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all501->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all501);
   ...
   gre->SetPoint(12,312.5,0);
   gre->SetPointError(12,12.5,0);
   gre->SetPoint(13,337.5,213.8338);
   gre->SetPointError(13,12.5,11.71005);
   gre->SetPoint(14,362.5,165.2829);
   gre->SetPointError(14,12.5,9.298049);
   gre->SetPoint(15,387.5,0);
   gre->SetPointError(15,12.5,0);
   gre->SetPoint(16,412.5,0);
   gre->SetPointError(16,12.5,0);
   ...
   TH1F *Graph_Graph_from_HT_all502 = new TH1F("Graph_Graph_from_HT_all502","",100,0,2750);
   Graph_Graph_from_HT_all502->SetMinimum(0.2480982);
   Graph_Graph_from_HT_all502->SetMaximum(248.0982);
   Graph_Graph_from_HT_all502->SetDirectory(0);
   Graph_Graph_from_HT_all502->SetStats(0);
   Graph_Graph_from_HT_all502->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all502->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all502->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all502->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all502->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all502->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all502->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all502->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all502->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all502->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all502);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis3010[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3010);
   HT_all->SetBinContent(14,47);
   HT_all->SetBinContent(15,52);
   HT_all->SetBinError(14,6.855655);
   HT_all->SetBinError(15,7.211103);
   ...
   HT_all->Draw("PSAME");
   u->Modified();
   canvasDiMuon_325_375/HT_all->cd();
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis3011[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3011);
   HT_all->SetBinContent(14,0.2197969);
   HT_all->SetBinContent(15,0.3146122);
   HT_all->SetBinError(14,0.155806);
   HT_all->SetBinError(15,0.149651);
   HT_all->SetMinimum(0);
   HT_all->SetMaximum(2);
   HT_all->SetEntries(85.25853);
   HT_all->SetLineWidth(2);
   HT_all->SetMarkerStyle(20);
   HT_all->SetMarkerSize(1.5);
   HT_all->GetXaxis()->SetRange(1,51);
   ...
   gre->SetPointError(13,12.5,0.05476241);
   gre->SetPoint(14,362.5,1);
   gre->SetPointError(14,12.5,0.05625537);
   ...
   TH1F *Graph_Graph_from_HT_all503 = new TH1F("Graph_Graph_from_HT_all503","",100,0,2750);
   Graph_Graph_from_HT_all503->SetMinimum(0.9324936);
   Graph_Graph_from_HT_all503->SetMaximum(1.067506);
   Graph_Graph_from_HT_all503->SetDirectory(0);
   Graph_Graph_from_HT_all503->SetStats(0);
   Graph_Graph_from_HT_all503->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all503->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all503->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all503->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_HT_all503->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all503->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all503->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_HT_all503->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_HT_all503->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_HT_all503->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_HT_all503);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,1270,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis3012[101] = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450, 475, 500, 525, 550, 575, 600, 625, 650, 675, 700, 725, 750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1050, 1075, 1100, 1125, 1150, 1175, 1200, 1225, 1250, 1275, 1300, 1325, 1350, 1375, 1400, 1425, 1450, 1475, 1500, 1525, 1550, 1575, 1600, 1625, 1650, 1675, 1700, 1725, 1750, 1775, 1800, 1825, 1850, 1875, 1900, 1925, 1950, 1975, 2000, 2025, 2050, 2075, 2100, 2125, 2150, 2175, 2200, 2225, 2250, 2275, 2300, 2325, 2350, 2375, 2400, 2425, 2450, 2475, 2500}; 
   
   TH1D *HT_all = new TH1D("HT_all","",100, xAxis3012);
   HT_all->SetBinContent(14,0.2197969);
   HT_all->SetBinContent(15,0.3146122);
   HT_all->SetBinError(14,0.155806);
   HT_all->SetBinError(15,0.149651);
   ...
   d->Modified();
   canvasDiMuon_325_375/HT_all->cd();
   canvasDiMuon_325_375/HT_all->Modified();
   canvasDiMuon_325_375/HT_all->cd();
   canvasDiMuon_325_375/HT_all->SetSelected(canvasDiMuon_325_375/HT_all);
}
