{
//=========Macro generated from canvas: canvasbtag_morethanzero_DiMuon_675_775/MT__all/cannameMT__all
//=========  (Thu May 10 12:47:32 2012) by ROOT version5.32/00
   TCanvas *canvasbtag_morethanzero_DiMuon_675_775/MT__all = new TCanvas("canvasbtag_morethanzero_DiMuon_675_775/MT__all", "cannameMT__all",0,0,1200,1200);
   gStyle->SetOptStat(0);
   canvasbtag_morethanzero_DiMuon_675_775/MT__all->SetHighLightColor(2);
   canvasbtag_morethanzero_DiMuon_675_775/MT__all->Range(0,0,1,1);
   canvasbtag_morethanzero_DiMuon_675_775/MT__all->SetFillColor(0);
   canvasbtag_morethanzero_DiMuon_675_775/MT__all->SetBorderMode(0);
   canvasbtag_morethanzero_DiMuon_675_775/MT__all->SetBorderSize(2);
   canvasbtag_morethanzero_DiMuon_675_775/MT__all->SetTickx(1);
   canvasbtag_morethanzero_DiMuon_675_775/MT__all->SetTicky(1);
   canvasbtag_morethanzero_DiMuon_675_775/MT__all->SetFrameBorderMode(0);
  
// ------------>Primitives in pad: u
   TPad *u = new TPad("u", "u",0.01,0.25,0.99,0.99);
   u->Draw();
   u->cd();
   u->Range(-102.5,-0.5232989,922.5,1.69939);
   u->SetFillColor(0);
   u->SetBorderMode(0);
   u->SetBorderSize(2);
   u->SetLogy();
   ...
   MT__all->Draw("PE0");
   Double_t xAxis4952[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis4952);
   ...
   Double_t xAxis4953[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis4953);
   ...
   MT__all->GetXaxis()->SetRange(1,41);
   MT__all->Draw("HISTSAME");
   Double_t xAxis4954[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis4954);
   MT__all->SetEntries(1);
   ...
   MT__all->GetXaxis()->SetRange(1,41);
   MT__all->Draw("HISTSAME");
   Double_t xAxis4955[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis4955);
   MT__all->SetBinContent(2,0.03021939);
   MT__all->SetBinContent(3,0.03021939);
   MT__all->SetBinContent(6,1.342215);
   MT__all->SetBinContent(8,0.4071855);
   MT__all->SetBinContent(9,0.1608371);
   MT__all->SetBinContent(11,0.6678838);
   MT__all->SetBinError(2,0.03021939);
   MT__all->SetBinError(3,0.03021939);
   MT__all->SetBinError(6,0.7962171);
   MT__all->SetBinError(8,0.4071855);
   MT__all->SetBinError(9,0.1608371);
   ...
   MT__all->GetXaxis()->SetRange(1,41);
   MT__all->Draw("HISTSAME");
   Double_t xAxis4956[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis4956);
   ...
   MT__all->GetXaxis()->SetRange(1,41);
   MT__all->Draw("HISTSAME");
   Double_t xAxis4957[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis4957);
   MT__all->SetBinContent(3,0.02111917);
   MT__all->SetBinContent(6,0.00461681);
   MT__all->SetBinError(3,0.01220075);
   MT__all->SetBinError(6,0.00461681);
   MT__all->SetEntries(5);
   MT__all->SetLineColor(44);
   MT__all->SetLineWidth(3);
   MT__all->GetXaxis()->SetTitle("M){T} [GeV]");
   MT__all->GetXaxis()->SetRange(1,41);
   MT__all->Draw("HISTSAME");
   Double_t xAxis4958[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis4958);
   MT__all->SetEntries(1);
   ...
   MT__all->GetXaxis()->SetRange(1,41);
   MT__all->Draw("HISTSAME");
   Double_t xAxis4959[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis4959);
   MT__all->SetBinContent(1,0.3346618);
   MT__all->SetBinContent(2,0.3221947);
   MT__all->SetBinContent(3,0.1319305);
   MT__all->SetBinContent(4,0.6564163);
   MT__all->SetBinContent(5,0.2353455);
   MT__all->SetBinContent(6,1.346831);
   MT__all->SetBinContent(8,0.4071855);
   MT__all->SetBinContent(9,0.1608371);
   MT__all->SetBinContent(11,0.6678838);
   MT__all->SetBinError(1,0.3346618);
   MT__all->SetBinError(2,0.2439419);
   MT__all->SetBinError(3,0.08693173);
   MT__all->SetBinError(4,0.3892593);
   MT__all->SetBinError(5,0.2353455);
   MT__all->SetBinError(6,0.7962305);
   MT__all->SetBinError(8,0.4071855);
   MT__all->SetBinError(9,0.1608371);
   MT__all->SetBinError(11,0.6678838);
   ...
   TH1F *Graph_Graph_from_MT__all826 = new TH1F("Graph_Graph_from_MT__all826","",100,0,2200);
   Graph_Graph_from_MT__all826->SetMinimum(0.0011);
   Graph_Graph_from_MT__all826->SetMaximum(1.1);
   Graph_Graph_from_MT__all826->SetDirectory(0);
   Graph_Graph_from_MT__all826->SetStats(0);
   Graph_Graph_from_MT__all826->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all826->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all826->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MT__all826->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_MT__all826->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all826->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all826->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MT__all826->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all826->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all826->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_MT__all826);
   ...
   gre->SetPoint(1,30,0.3221947);
   gre->SetPointError(1,10,0.2439419);
   gre->SetPoint(2,50,0.1319305);
   gre->SetPointError(2,10,0.08693173);
   gre->SetPoint(3,70,0.6564163);
   gre->SetPointError(3,10,0.3892593);
   gre->SetPoint(4,90,0.2353455);
   gre->SetPointError(4,10,0.2353455);
   gre->SetPoint(5,110,1.346831);
   gre->SetPointError(5,10,0.7962305);
   gre->SetPoint(6,130,0);
   gre->SetPointError(6,10,0);
   gre->SetPoint(7,150,0.4071855);
   gre->SetPointError(7,10,0.4071855);
   gre->SetPoint(8,170,0.1608371);
   gre->SetPointError(8,10,0.1608371);
   gre->SetPoint(9,190,0);
   gre->SetPointError(9,10,0);
   ...
   TH1F *Graph_Graph_from_MT__all827 = new TH1F("Graph_Graph_from_MT__all827","",100,0,2200);
   Graph_Graph_from_MT__all827->SetMinimum(0.002357368);
   Graph_Graph_from_MT__all827->SetMaximum(2.357368);
   Graph_Graph_from_MT__all827->SetDirectory(0);
   Graph_Graph_from_MT__all827->SetStats(0);
   Graph_Graph_from_MT__all827->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all827->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all827->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MT__all827->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_MT__all827->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all827->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all827->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MT__all827->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all827->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all827->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_MT__all827);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
   Double_t xAxis4960[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis4960);
   MT__all->SetBinContent(3,1);
   MT__all->SetBinContent(4,3);
   MT__all->SetBinContent(5,2);
   MT__all->SetBinContent(7,2);
   ...
   MT__all->Draw("PSAME");
   u->Modified();
   canvasbtag_morethanzero_DiMuon_675_775/MT__all->cd();
...
// ------------>Primitives in pad: d
   ...
   d->SetFrameBorderMode(0);
   Double_t xAxis4961[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis4961);
   MT__all->SetBinContent(3,7.57975);
   MT__all->SetBinContent(4,4.57027);
   MT__all->SetBinContent(5,8.498143);
   MT__all->SetBinError(3,1.197571);
   MT__all->SetBinError(4,0.9276321);
   MT__all->SetBinError(5,1.414214);
   MT__all->SetMinimum(0);
   MT__all->SetMaximum(2);
   MT__all->SetEntries(1.741558);
   MT__all->SetLineWidth(2);
   MT__all->SetMarkerStyle(20);
   MT__all->SetMarkerSize(1.5);
   MT__all->GetXaxis()->SetRange(1,41);
   ...
   gre->SetPoint(1,30,1);
   gre->SetPointError(1,10,0.7571258);
   gre->SetPoint(2,50,1);
   gre->SetPointError(2,10,0.6589208);
   gre->SetPoint(3,70,1);
   gre->SetPointError(3,10,0.5930067);
   gre->SetPoint(4,90,1);
   gre->SetPointError(4,10,1);
   gre->SetPoint(5,110,1);
   gre->SetPointError(5,10,0.591188);
   ...
   TH1F *Graph_Graph_from_MT__all828 = new TH1F("Graph_Graph_from_MT__all828","",100,0,2200);
   Graph_Graph_from_MT__all828->SetMinimum(-0.2);
   Graph_Graph_from_MT__all828->SetMaximum(2.2);
   Graph_Graph_from_MT__all828->SetDirectory(0);
   Graph_Graph_from_MT__all828->SetStats(0);
   Graph_Graph_from_MT__all828->GetXaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all828->GetXaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all828->GetXaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MT__all828->GetXaxis()->SetTitleSize(0.05);
   Graph_Graph_from_MT__all828->GetYaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all828->GetYaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all828->GetYaxis()->SetLabelSize(0.05);
   Graph_Graph_from_MT__all828->GetZaxis()->SetLabelFont(42);
   Graph_Graph_from_MT__all828->GetZaxis()->SetLabelOffset(0.007);
   Graph_Graph_from_MT__all828->GetZaxis()->SetLabelSize(0.05);
   gre->SetHistogram(Graph_Graph_from_MT__all828);
   
   gre->Draw("2");
   TLine *line = new TLine(0,1,820,1);
   line->SetLineWidth(3);
   line->Draw();
   Double_t xAxis4962[101] = {0, 20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340, 360, 380, 400, 420, 440, 460, 480, 500, 520, 540, 560, 580, 600, 620, 640, 660, 680, 700, 720, 740, 760, 780, 800, 820, 840, 860, 880, 900, 920, 940, 960, 980, 1000, 1020, 1040, 1060, 1080, 1100, 1120, 1140, 1160, 1180, 1200, 1220, 1240, 1260, 1280, 1300, 1320, 1340, 1360, 1380, 1400, 1420, 1440, 1460, 1480, 1500, 1520, 1540, 1560, 1580, 1600, 1620, 1640, 1660, 1680, 1700, 1720, 1740, 1760, 1780, 1800, 1820, 1840, 1860, 1880, 1900, 1920, 1940, 1960, 1980, 2000}; 
   
   TH1D *MT__all = new TH1D("MT__all","",100, xAxis4962);
   MT__all->SetBinContent(3,7.57975);
   MT__all->SetBinContent(4,4.57027);
   MT__all->SetBinContent(5,8.498143);
   MT__all->SetBinError(3,1.197571);
   ...
   d->Modified();
   canvasbtag_morethanzero_DiMuon_675_775/MT__all->cd();
   canvasbtag_morethanzero_DiMuon_675_775/MT__all->Modified();
   canvasbtag_morethanzero_DiMuon_675_775/MT__all->cd();
   canvasbtag_morethanzero_DiMuon_675_775/MT__all->SetSelected(canvasbtag_morethanzero_DiMuon_675_775/MT__all);
}
